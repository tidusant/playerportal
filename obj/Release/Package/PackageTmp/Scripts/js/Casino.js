$(function () {
	...
	//	getUserViaSession();
	//}
	list("Slots", "mr_slotty", true, true, 150, 150);
});
...
function list(byCategory, byVendor, showHiddenGames, showImages, desiredImageWidth, desiredImageHeight, pageSize, currentPage) {
	games.list(byCategory, byVendor, showHiddenGames, showImages, desiredImageWidth, desiredImageHeight, pageSize, currentPage);
}
