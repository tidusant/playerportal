...
(function () {
    (function (b, h, g) {
        var f, e; e = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent); f = function () {
            function d(a, c) { this.options = b.extend(!0, {}, this.Defaults, c); this.$element = b(a); this.$wrap = this.$element.wrap('<div class="rd-select"></div>').parent(); this.$pseudoOptions = this.$pseudoValue = null; this.$win = b(g); this.$doc = b(h); this.initialize() } d.prototype.Defaults = { valueIconClass: "rd-select-value-icon fa-angle-down", callbacks: null }; d.prototype.initialize = function () {
                this.hideOriginalDOM();
                this.createPseudoDOM(); this.applyHandlers(); return this
            }; d.prototype.createPseudoDOM = function () {
                var a; a = this; a.$pseudoValue = b("<div/>", { "class": "rd-select-trigger " + a.$element.get(0).className }).append('<span class="rd-select-value">' + a.$element.find("option:selected").text() + "</span>").append('<span class="' + a.options.valueIconClass + '"></span>'); a.$pseudoOptions = b("<ul/>", { "class": "rd-select-menu" }); a.$element.find("option").each(function () {
                    var c; c = b(this); return a.$pseudoOptions.append(b("<li/>",
                      { "class": "rd-select-option", text: c.text() }).addClass(c.is(":selected") ? "selected" : !1))
                }); a.$wrap.append(a.$pseudoValue).append(a.$pseudoOptions); return a
            }; d.prototype.hideOriginalDOM = function () { this.$element.css({ position: "absolute", margin: 0, padding: 0, top: 0, left: 0, width: e ? "100%" : 0, height: e ? "100%" : 0, border: "none", overflow: "hidden", opacity: 0, "z-index": e ? 9999999 : -9999999 }); return this }; d.prototype.open = function () {
                this.$wrap.addClass("rd-select-open"); this.$element.is(":focus") || this.$element.focus();
                return this
            }; d.prototype.close = function () { this.$wrap.removeClass("rd-select-open"); return this }; d.prototype.change = function (a, c) { var d; d = b(this); a.$element.val(d.text()).trigger("change").trigger("propertychange").focus(); "click" === c.type && b.proxy(a.close, a)(); return this }; d.prototype.originalChange = function () {
                this.$pseudoValue.find(".rd-select-value").text(this.$element.val()); this.$pseudoOptions.find(".rd-select-option").eq(this.$element.find("option:selected").index()).addClass("selected").siblings().removeClass("selected");
                return this
            }; d.prototype.keyDown = function (a) {
                var c; switch (a.keyCode) {
                    case 32: case 37: case 39: a.preventDefault(); break; case 38: a.preventDefault(); c = this.$pseudoOptions.find(".rd-select-option.selected").prev(); c.length && b.proxy(this.change, c[0], this)(a); break; case 40: a.preventDefault(); c = this.$pseudoOptions.find(".rd-select-option.selected").next(); c.length && b.proxy(this.change, c[0], this)(a); break; case 13: a.preventDefault(), this.$wrap.hasClass("rd-select-open") ? b.proxy(this.close, this)() : b.proxy(this.open,
                      this)()
                }
            }; d.prototype.applyHandlers = function () {
                var a; a = this; e || (a.$element.on("focus", b.proxy(a.open, a)), a.$doc.find("*").on("focus", function (c) { c = c.target; if (c !== a.$element[0] && !b(c).parents(".rd-select-menu").length) return b.proxy(a.close, a)() }), a.$element.on("keydown", b.proxy(a.keyDown, a)), a.$pseudoValue.on("click", b.proxy(a.open, a)), a.$pseudoOptions.find("li").each(function () { return b(this).on("click", b.proxy(a.change, this, a)) }), a.$doc.on("click", function (c) {
                    c = c.target; if (c !== a.$wrap[0] && !b(c).parents(".rd-select").length) return b.proxy(a.close,
                    a)()
                })); a.$element.on("change propertychange", b.proxy(a.originalChange, a)); return a
            }; return d
        }(); b.fn.extend({ RDSelectMenu: function (d) { return this.each(function () { var a; a = b(this); if (!a.data("RDSelectMenu")) return a.data("RDSelectMenu", new f(this, d)) }) } }); return g.RDSelectMenu = f
    })(window.jQuery, document, window); "undefined" !== typeof module && null !== module ? module.exports = window.RDSelectMenu : "function" === typeof define && define.amd && define(["jquery"], function () { return window.RDSelectMenu })
}).call(this);
/**
...
(function () {
    (function (d, q, p) {
        var g; g = function () {
            function c(a, b) { this.options = d.extend(!0, {}, this.Defaults, b); this.$form = d(a); this.$inputs = this.$form.find("input, textarea").filter(this.options.dataAttr); this.submitBtn = d("button[type='submit']"); this.$inputs.length && this.initialize() } c.prototype.Defaults = {
                "class": "mfValidation", dataAttr: "[data-constraints]", constraints: {
                    "@LettersOnly": {
                        rule: "^([a-zA-Z\u0430-\u044f\u0410-\u042f\u0456\u0457\u0451\u0406\u0407\u0401\u0454\u0404\u0490\u0491\\s]{0,})$",
                        message: "Please use letters only!"
                    }, "@NumbersOnly": { rule: "^-?\\d*\\.?\\d*$", message: "Please use numbers only!" }, "@NotEmpty": { rule: /.*\S.*/, message: "Field should not be empty!" }, "@Email": { rule: "^(([\\w-]+(?:\\.[\\w-]+)*)@((?:[\\w-]+\\.)*\\w[\\w-]{0,66})\\.([a-z]{2,6}(?:\\.[a-z]{2})?)){0,}$", message: "Enter valid e-mail address!" }, "@Phone": { rule: "^(\\+?\\d{0,3}\\s*\\(?\\d{1,3}\\)?\\s*\\d{3}\\s*\\d{4}){0,}$", message: "Enter valid phone number!" }, "@Date": {
                        rule: function (a) {
                    ...
                    }, "@SelectRequired": { rule: function (a) { return 0 !== a.find("option:selected").index() }, message: "Please choose an option!" }
                }
            }; c.prototype.initialize = function () { this.initDOM(); this.applyHandlers(); return this };
            c.prototype.initDOM = function () { this.$form.find("input, textarea").wrap("<div class='mfInput'></div>").parent().append("<div class='mfValidation'></div>"); this.$form.find(this.options.dataAttr).wrap(d("</div>", { "class": this.options["class"] })); return this }; c.prototype.applyHandlers = function () {
                var a; a = this; a.$inputs.on("blur keyup", function (b) { return a.validateInput(d(b.target), a.options) }); a.$form.on("submit", function (b) {
                    a.validateInput(a.$inputs, a.options); if (a.$form.find("[data-invalid]").length) return b.preventDefault(),
                      !1
                }); return a
            }; c.prototype.validateInput = function (a, b) {
                var c; c = this; d.each(a, function (a, g) { var f, h, k, m, e, l, n; f = d(g); l = f.data("constraints").match(/\@\w+/g); n = f.val(); h = []; k = 0; for (m = l.length; k < m; k++) if (e = l[k], b.constraints[e].rule) switch (typeof b.constraints[e].rule) { case "function": b.constraints[e].rule(f) || h.push(b.constraints[e].message); break; default: (new RegExp(b.constraints[e].rule)).test(n) || h.push(b.constraints[e].message) } return h.length ? c.validationError(f, b, h) : c.validationSuccess(f, b) });
                return c
            }; c.prototype.validationError = function (a, b, c) { return a.siblings("." + b["class"]).addClass(b["class"] + "--active").text(c[0]).attr("data-invalid", "") }; c.prototype.validationSuccess = function (a, b) { return a.siblings("." + b["class"]).removeClass(b["class"] + "--active").text("").removeAttr("data-invalid") }; return c
        }(); d.fn.extend({ RDValidator: function (c) { return this.each(function () { var a; a = d(this); if (!a.data("RDValidator")) return a.data("RDValidator", new g(this, c)) }) } }); return p.RDValidator = g
    })(window.jQuery,
      document, window); "undefined" !== typeof module && null !== module ? module.exports = window.RDValidator : "function" === typeof define && define.amd && define(["jquery"], function () { return window.RDValidator })
}).call(this);
/**
...
(function () {
    (function (c, w, u) {
        var l, v; v = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent); l = function () {
            function d(a, b) { this.options = c.extend(!0, {}, this.Defaults, b); this.$element = c(a); this.$picker = null; this.$win = c(u); this.$doc = c(w); v ? this.options.mobile && this.initialize() : this.initialize() } d.prototype.Defaults = {
                mobile: !1, days: "Su Mo Tu We Th Fr Sa".split(" "), months: "January February March April May June July August September October November December".split(" "),
                format: "mm-dd-yyyy", prevClass: "rd-datepicker-prev fa-angle-left", nextClass: "rd-datepicker-next fa-angle-right", prevText: "", nextText: "", callbacks: null
            }; d.prototype.initialize = function () { var a; (a = this.$element.attr("type")) && "date" === a && this.$element.attr("type", "text"); this.createPickerDOM().applyHandlers(); return this }; d.prototype.createPickerDOM = function () {
                this.$picker = c("<div/>", { "class": "rd-datepicker" }).data("date", new Date).append("<div class='rd-datepicker-header'> <span class='" + this.options.prevClass +
                  "'>" + this.options.prevText + "</span> <span class='" + this.options.nextClass + "'>" + this.options.nextText + "</span> <div class='rd-datepicker-title'></div> </div><div class='rd-datepicker-body'></div>"); this.$element.after(this.$picker); this.refresh(); return this
            }; d.prototype.applyHandlers = function () {
                var a; a = this; a.$element.on("focus", c.proxy(a.open, a)); a.$element.on("input change propertychange", c.proxy(a.open, a)); a.$doc.find("*").on("focus", function (b) {
                    b = b.target; if (b !== a.$element[0] && b !== a.$picker[0] &&
                    !c(b).parents(".rd-datepicker").length) return c.proxy(a.close, a)()
                }); a.$picker.on("click", ".rd-datepicker-day", a, a.pick); a.$picker.on("click", ".rd-datepicker-next", c.proxy(a.next, a)); a.$picker.on("click", ".rd-datepicker-prev", c.proxy(a.prev, a)); a.$doc.on("click", function (b) { b = b.target; if (b !== a.$element[0] && b !== a.$picker[0] && !c(b).parents(".rd-datepicker").length) return c.proxy(a.close, a)() }); return a
            }; d.prototype.next = function () {
                var a; a = this.$picker.data("date"); a = 11 === a.getMonth() ? new Date(a.getFullYear() +
                1, 0, 1) : new Date(a.getFullYear(), a.getMonth() + 1, 1); this.$picker.data("date", a); this.refresh(); return this
            ...
            function (a) { var b; a = a.data; b = c(this).addClass("selected").data("date"); a.$picker.data("pickedDate", b).find(".rd-datepicker-day").not(this).removeClass("selected"); a.$element.val(b.format(a.options.format)); a.$element.focus(); setTimeout(c.proxy(a.close, a)); return this }; d.prototype.refresh = function () {
                var a, b, d, f, e, g, h, k, p, m, l, q, r, t, n; f = this.$picker.data("date"); n = new Date; r = this.$picker.data("pickedDate"); q = (new Date(f.getFullYear(), f.getMonth() + 1, 0)).getDate(); t = (new Date(f.getFullYear(), f.getMonth(),
                0)).getDate(); k = (new Date(f.getFullYear(), f.getMonth(), 1)).getDay(); d = 1; n.setHours(0); n.setMinutes(0); n.setSeconds(0); n.setMilliseconds(0); a = c("<table>"); b = c("<tr/>"); m = this.options.days; g = 0; for (p = m.length; g < p; g++) e = m[g], b.append("<th class='rd-datepicker-week'>" + e + "</th>"); a.append(b); for (p = m = 0; 6 >= m; p = ++m) {
                    b = c("<tr/>"); for (h = l = 0; 6 >= l; h = ++l) {
                        e = 7 * p + h + 1; g = "rd-datepicker-day"; if (0 === h && e > q + k) break; 1 > e - k ? (h = t + e - k, g += " offset", e = new Date(f.getFullYear(), f.getMonth() - 1, t + (e - k))) : e <= q + k ? (h = e - k, e = new Date(f.getFullYear(),
                        f.getMonth(), e - k)) : (h = d, g += " offset", e = new Date(f.getFullYear(), f.getMonth() + 1, d++)); e.valueOf() === n.valueOf() && (g += " today"); r && e.valueOf() === r.valueOf() && (g += " selected"); b.append(c("<td/>", { "class": g, text: h }).data("date", e))
                    } "" !== b.html() && a.append(b)
                } this.$picker.find(".rd-datepicker-title").text(this.options.months[f.getMonth()] + " " + f.getFullYear()).end().find(".rd-datepicker-body").html(a); return this
            }; return d
        }(); c.fn.extend({
    ...
    })(window.jQuery, document, window); "undefined" !== typeof module && null !== module ? module.exports = window.RDDatePicker : "function" === typeof define && define.amd && define(["jquery"], function () { return window.RDDatePicker })
}).call(this);
/**
 * @module       Date Format
...
var dateFormat = function () {
    var l = /d{1,4}|m{1,4}|yy(?:yy)?|([HhMsTt])\1?|[LloSZ]|"[^"]*"|'[^']*'/g, m = /\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g, v = /[^-+\dA-Z]/g, d = function (a, c) { a = String(a); for (c = c || 2; a.length < c;) a = "0" + a; return a }; return function (a, c, h) {
        ...
        c = String(f.masks[c] || c || f.masks["default"]); "UTC:" == c.slice(0, 4) && (c = c.slice(4), h = !0); var b = h ? "getUTC" : "get", g = a[b + "Date"](), p = a[b + "Day"](), k = a[b + "Month"](), q = a[b + "FullYear"](), e = a[b + "Hours"](), r = a[b + "Minutes"](), t = a[b + "Seconds"](), b = a[b + "Milliseconds"](), n = h ? 0 : a.getTimezoneOffset(), u = {
            d: g, dd: d(g), ddd: f.i18n.dayNames[p], dddd: f.i18n.dayNames[p + 7], m: k + 1, mm: d(k + 1), mmm: f.i18n.monthNames[k], mmmm: f.i18n.monthNames[k + 12], yy: String(q).slice(2), yyyy: q, h: e % 12 || 12, hh: d(e % 12 || 12), H: e, HH: d(e), M: r, MM: d(r), s: t,
...
(function () {
    (function (c, f, e) {
        var d; d = function () {
            function b(a, b) { this.options = c.extend(!0, {}, this.Defaults, b); this.$element = c(a); this.$dropZone = c("." + this.options.dropZoneClass); this.$button = c("." + this.options.buttonClass); this.$meta = c("." + this.options.metaFieldClass); this.$input = this.$element.find("input[type='file']"); this.initialize() } b.prototype.Defaults = {
                buttonClass: null, dropZoneClass: null, metaFieldClass: null, "multiple\u0421aption": "{count} files selected", mouseOverClass: "file-grabbing", callbacks: {
                    onInit: !1,
                    onValueChange: !1, onFileDrop: !1
                }
            }; b.prototype.initialize = function () { this.applyHandlers(); this.options.callbacks.onInit && this.options.callbacks.onInit.call(this, this); return this }; b.prototype.applyHandlers = function () {
                var a; a = this; if (0 !== a.$button.length) a.$button.on("click", function (b) { b.preventDefault(); b.stopPropagation(); return a.$input.trigger("click") }); else a.$element.on("click", function (b) { b.stopPropagation(); return a.$input.trigger("click") }); if (0 !== a.$dropZone.length) a.$dropZone.on("drag dragstart dragend dragover dragenter dragleave drop",
                  function (a) { a.preventDefault(); return a.stopPropagation() }).on("dragover dragenter", c.proxy(a.dragEnterHandler, a)).on("dragleave dragend drop", c.proxy(a.dragEndHandler, a)).on("drop", c.proxy(a.dropHandler, a)); a.$input.on("click", function (a) { return a.stopPropagation() }); a.$input.on("change", c.proxy(a.changeHandler, a)); return a
            }; b.prototype.dragEnterHandler = function (a) { this.$element.addClass(this.options.mouseOverClass); return this }; b.prototype.dragEndHandler = function (a) {
                this.$element.removeClass(this.options.mouseOverClass);
                return this
            }; b.prototype.dropHandler = function (a) { this.updateMeta(a.originalEvent.dataTransfer.files); this.$input[0].files = a.originalEvent.dataTransfer.files; this.options.callbacks.onFileDrop && this.options.callbacks.onFileDrop.call(this, this, a.originalEvent.dataTransfer.files); return this }; b.prototype.changeHandler = function (a) { this.updateMeta(this.$input[0].files); this.options.callbacks.onValueChange && this.options.callbacks.onValueChange.call(this, this, this.$input[0].files); return this }; b.prototype.updateMeta =
              function (a) { this.$meta.text(1 < a.length ? this.options.multiple\u0421aption.replace("{count}", a.length + "") : a[0].name); return this }; return b
        }(); c.fn.extend({ RDFilepicker: function (b) { return this.each(function () { var a; a = c(this); if (!a.data("RDFilepicker")) return a.data("RDFilepicker", new d(this, b)) }) } }); return e.RDFilepicker = d
    })(window.jQuery, document, window); "undefined" !== typeof module && null !== module ? module.exports = window.RDFilepicker : "function" === typeof define && define.amd && define(["jquery"], function () { return window.RDFilepicker })
}).call(this);
/**
...
(function () {
    (function (d, h, k) {
        var f, g; g = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent); f = function () {
            function c(a, b) {
                ...
                this.$cachedDom.clockMinutes = this.$cachedDom.popup.find(".rd-timepicker-display__minutes"); this.$cachedDom.clockHoursItems = null; this.$cachedDom.clockMinutesItems = null; this.$cachedDom.clockHoursActive = null; this.$cachedDom.clockMinutesActive = null; this.isAcive = !1; this.activeDisplay = this.$cachedDom.clockHours; this.initialize()
            } c.prototype.Defaults = { callbacks: { onOpen: !1, onClose: !1, onDisplayChange: !1 }, timeFormat: "hh|:|mm| |tz", currentValue: { hh: "12", mm: "00", isAM: !0 } }; c.prototype.initialize = function () {
                this.initDOM();
                this.applyHandlers(); return this
                ...
                a.$cachedDom.meridiems.on("click", d.proxy(a.meridiemSelectHandler, a)); return a
                ...
                d.stopPropagation(); d.preventDefault(); this.setDisplayTime(c, d.target); c ? this.hideTimePicker() : this.changeDisplay(c);
                return this
                ...
                var b; b = this; d.each(b.$cachedDom.clocks, function () { this.classList.toggle(b.settings.displayActiveClass); return b }); b.rotateLine(a);
                b.$cachedDom.panelHoursToggle[0].classList.toggle(b.settings.panelActiveClass); b.$cachedDom.panelMinutesToggle[0].classList.toggle(b.settings.panelActiveClass); b.options.callbacks.onDisplayChange && b.options.callbacks.onDisplayChange.call(this, b); return b
...
(function () {
    (function (b, k, l) {
        var g; g = function () {
            function d(a) { this.options = b.extend(!0, {}, this.Defaults, a); this.toggles = b("." + this.options.toggleClass); this.checkboxs = b("." + this.options.checkboxClass); this.radiobtns = b("." + this.options.radioClass); this.initialize() } var e; e = function () {
                function a(h, a) {
                    this.elemClass = a; "input" === h.tagName.toLowerCase() ? this.$element = b(h) : this.$element = b(h).find("input[type='checkbox']"); this.$wrap = this.$element.wrap("<div class=" + this.elemClass + "-outer></div>").parent();
                    this.$element[0].checked ? this.$wrap.addClass("active") : this.$wrap.removeClass("active"); this.addHandlers()
                } a.prototype.addHandlers = function () { if ("radio" === this.$element[0].type) this.$wrap.on("click", b.proxy(this.radioHandler, this)); else return this.$wrap.on("click", b.proxy(this.checkboxHandler, this)) }; a.prototype.checkboxHandler = function (a) {
                ...
                }; a.prototype.radioHandler = function (a) { var c; c = this; b("[name=" + c.$element[0].name + "]").each(function () { this.checked = !1; return b(this).closest("." + c.elemClass + "-outer").removeClass("active") }); c.$wrap.addClass("active"); return c.$element[0].checked = !0 }; return a
            }(); d.prototype.Defaults = { toggleClass: "mfToggle__input", radioClass: "mfRadio__input", checkboxClass: "mfCheckbox__input" }; d.prototype.initialize = function () {
                var a, b, c, f, d; c = this.toggles; a = 0; for (b = c.length; a <
              b; a++) f = c[a], new e(f, this.options.toggleClass); f = this.checkboxs; b = 0; for (c = f.length; b < c; b++) a = f[b], new e(a, this.options.checkboxClass); f = this.radiobtns; d = []; a = 0; for (b = f.length; a < b; a++) c = f[a], d.push(new e(c, this.options.radioClass)); return d
            }; return d
        }(); b.RDToggles = function (d) { var e; e = b(k); if (!e.data("RDToggles")) return e.data("RDToggles", new g(d)) }; return l.RDToggles = g
    })(window.jQuery, document, window); "undefined" !== typeof module && null !== module ? module.exports = window.RDToggles : "function" === typeof define &&
 ...
 */
(function (f) {
    function A(a) { a = a.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i, function (a, b, d, e) { return b + b + d + d + e + e }); return (a = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(a)) ? { r: parseInt(a[1], 16), g: parseInt(a[2], 16), b: parseInt(a[3], 16) } : null } function B() { var a = document.createElement("canvas"); return !(!a.getContext || !a.getContext("2d")) } function n() { return Math.floor(65536 * (1 + Math.random())).toString(16).substring(1) } function z(a, c, b, d, e) {
        for (var h = {}, l = {}, f = {}, g = {}, m = {}, k = {}, r = null, q = 0; q < d.length; q++) {
            var p =
                d[q], r = null === r ? b / t[p] : t[r] / t[p], u = a / t[p], v = c / t[p]; e && (u = 0 < u ? Math.floor(u) : Math.ceil(u), v = 0 < v ? Math.floor(v) : Math.ceil(v)); "Days" !== p && (u %= r, v %= r); h[p] = u; f[p] = Math.abs(u); l[p] = v; k[p] = Math.abs(v); g[p] = Math.abs(u) / r; m[p] = Math.abs(v) / r; r = p
        } return { raw_time: h, raw_old_time: l, time: f, old_time: k, pct: g, old_pct: m }
    } function C(a) {
        for (var c = ["webkit", "moz"], b = 0; b < c.length && !a.requestAnimationFrame; ++b) a.requestAnimationFrame = a[c[b] + "RequestAnimationFrame"], a.cancelAnimationFrame = a[c[b] + "CancelAnimationFrame"]; a.requestAnimationFrame &&
    a.cancelAnimationFrame || (a.requestAnimationFrame = function (c, b, h) { "undefined" === typeof h && (h = { data: { last_frame: 0 } }); var l = (new Date).getTime(), f = Math.max(0, 16 - (l - h.data.last_frame)); b = a.setTimeout(function () { c(l + f) }, f); h.data.last_frame = l + f; return b }, a.cancelAnimationFrame = function (a) { clearTimeout(a) })
    } var m = window; Object.keys || (Object.keys = function () {
        var a = Object.prototype.hasOwnProperty, c = !{ toString: null }.propertyIsEnumerable("toString"), b = "toString toLocaleString valueOf hasOwnProperty isPrototypeOf propertyIsEnumerable constructor".split(" "),
            d = b.length; return function (e) { if ("object" !== typeof e && ("function" !== typeof e || null === e)) throw new TypeError("Object.keys called on non-object"); var h = [], l; for (l in e) a.call(e, l) && h.push(l); if (c) for (l = 0; l < d; l++) a.call(e, b[l]) && h.push(b[l]); return h }
    }()); var x = !1, y = ["Days", "Hours", "Minutes", "Seconds"], D = { Seconds: "Minutes", Minutes: "Hours", Hours: "Days", Days: "Years" }, t = { Seconds: 1, Minutes: 60, Hours: 3600, Days: 86400, Months: 2678400, Years: 31536E3 }; Array.prototype.indexOf || (Array.prototype.indexOf = function (a,
                                                                                                                                                                                                                                                                c) { var b = this.length >>> 0, d = Number(c) || 0, d = 0 > d ? Math.ceil(d) : Math.floor(d); for (0 > d && (d += b) ; d < b; d++) if (d in this && this[d] === a) return d; return -1 }); var w = {}, g = function (a, c) {
                                                                                                                                                                                                                                                                    this.element = a; this.container; this.listeners = null; this.data = {
                                                                                                                                                                                                                                                                        paused: !1, last_frame: 0, animation_frame: null, interval_fallback: null, timer: !1, total_duration: null, prev_time: null, drawn_units: [], text_elements: { Days: null, Hours: null, Minutes: null, Seconds: null }, attributes: { canvas: null, context: null, item_size: null, line_width: null, radius: null, outer_radius: null },
                                                                                                                                                                                                                                                                        state: { fading: { Days: !1, Hours: !1, Minutes: !1, Seconds: !1 } }
                                                                                                                                                                                                                                                                    }; this.config = null; this.setOptions(c); this.initialize()
                                                                                                                                                                                                                                                                }; g.prototype.clearListeners = function () { this.listeners = { all: [], visible: [] } }; g.prototype.addTime = function (a) { if (this.data.attributes.ref_date instanceof Date) { var c = this.data.attributes.ref_date; c.setSeconds(c.getSeconds() + a) } else isNaN(this.data.attributes.ref_date) || (this.data.attributes.ref_date += 1E3 * a) }; g.prototype.initialize = function (a) {
                                                                                                                                                                                                                                                                    this.data.drawn_units = []; for (var c = 0; c < Object.keys(this.config.time).length; c++) {
                                                                                                                                                                                                                                                                        var b =
                                                                                                                                                                                                                                                                          Object.keys(this.config.time)[c]; this.config.time[b].show && this.data.drawn_units.push(b)
                                                                                                                                                                                                                                                                    } f(this.element).children("div.time_circles").remove(); "undefined" === typeof a && (a = !0); (a || null === this.listeners) && this.clearListeners(); this.container = f("<div>"); this.container.addClass("time_circles"); this.container.appendTo(this.element); c = this.element.offsetHeight; a = this.element.offsetWidth; 0 === c && (c = f(this.element).height()); 0 === a && (a = f(this.element).width()); 0 === c && 0 < a ? c = a / this.data.drawn_units.length : 0 ===
                                                                                                                                                                                                                                                                a && 0 < c && (a = c * this.data.drawn_units.length); b = document.createElement("canvas"); b.width = a; b.height = c; this.data.attributes.canvas = f(b); this.data.attributes.canvas.appendTo(this.container); var d = B(); d || "undefined" === typeof G_vmlCanvasManager || (G_vmlCanvasManager.initElement(b), d = x = !0); d && (this.data.attributes.context = b.getContext("2d")); this.data.attributes.item_size = Math.min(a / this.data.drawn_units.length, c); this.data.attributes.line_width = this.data.attributes.item_size * this.config.fg_width; this.data.attributes.radius =
                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                    this.config.start || (this.data.paused = !0); var h = this; this.data.interval_fallback = m.setInterval(function () { h.update.call(h, !0) }, 100)
                                                                                                                                                                                                                                                                }; g.prototype.update = function (a) {
                                                                                                                                                                                                                                                                    if ("undefined" === typeof a) a = !1; else if (a && this.data.paused) return; x && this.data.attributes.context.clearRect(0, 0, this.data.attributes.canvas[0].width, this.data.attributes.canvas[0].hright); var c, b, d = this.data.prev_time; c = new Date; this.data.prev_time = c; null === d && (d = c); if (!this.config.count_past_zero && c > this.data.attributes.ref_date) {
                                                                                                                                                                                                                                                                        for (b =
                                                                                                                                                                                                                                                                                0; b < this.data.drawn_units.length; b++) { var e = this.data.drawn_units[b]; this.data.text_elements[e].text("0"); var h = b * this.data.attributes.item_size + this.data.attributes.item_size / 2, l = this.data.attributes.item_size / 2, f = this.config.time[e].color; this.drawArc(h, l, f, 0) } this.stop()
                                                                                                                                                                                                                                                                    } else {
                                                                                                                                                                                                                                                                        c = (this.data.attributes.ref_date - c) / 1E3; b = (this.data.attributes.ref_date - d) / 1E3; var e = "smooth" !== this.config.animation, d = z(c, b, this.data.total_duration, this.data.drawn_units, e), g = z(c, b, t.Years, y, e), k = b = 0, n = null, r = this.data.drawn_units.slice();
                                                                                                                                                                                                                                                                        for (b in y) e = y[b], Math.floor(g.raw_time[e]) !== Math.floor(g.raw_old_time[e]) && this.notifyListeners(e, Math.floor(g.time[e]), Math.floor(c), "all"), 0 > r.indexOf(e) || (Math.floor(d.raw_time[e]) !== Math.floor(d.raw_old_time[e]) && this.notifyListeners(e, Math.floor(d.time[e]), Math.floor(c), "visible"), a || (this.data.text_elements[e].text(Math.floor(Math.abs(d.time[e]))), h = k * this.data.attributes.item_size + this.data.attributes.item_size / 2, l = this.data.attributes.item_size / 2, f = this.config.time[e].color, "smooth" === this.config.animation ?
                                                                                                                                                                                                                                                                            (null === n || x || (Math.floor(d.time[n]) > Math.floor(d.old_time[n]) ? (this.radialFade(h, l, f, 1, e), this.data.state.fading[e] = !0) : Math.floor(d.time[n]) < Math.floor(d.old_time[n]) && (this.radialFade(h, l, f, 0, e), this.data.state.fading[e] = !0)), this.data.state.fading[e] || this.drawArc(h, l, f, d.pct[e])) : this.animateArc(h, l, f, d.pct[e], d.old_pct[e], (new Date).getTime() + 200)), n = e, k++); if (!this.data.paused && !a) {
                                                                                                                                                                                                                                                                                var q = this, p = function () { q.update.call(q) }; "smooth" === this.config.animation ? this.data.animation_frame = m.requestAnimationFrame(p,
                                                                                                                                                                                                                                                                                q.element, q) : (a = c % 1 * 1E3, 0 > a && (a = 1E3 + a), q.data.animation_frame = m.setTimeout(function () { q.data.animation_frame = m.requestAnimationFrame(p, q.element, q) }, a + 50))
                                                                                                                                                                                                                                                                            }
                                                                                                                                                                                                                                                                    }
                                                                                                                                                                                                                                                                }; g.prototype.animateArc = function (a, c, b, d, e, h) { if (null !== this.data.attributes.context) if (.5 < Math.abs(e - d)) 0 === d ? this.radialFade(a, c, b, 1) : this.radialFade(a, c, b, 0); else { var f = (200 - (h - (new Date).getTime())) / 200; 1 < f && (f = 1); this.drawArc(a, c, b, e * (1 - f) + d * f); if (!(1 <= f)) { var g = this; m.requestAnimationFrame(function () { g.animateArc(a, c, b, d, e, h) }, this.element) } } };
    g.prototype.drawArc = function (a, c, b, d) {
        if (null !== this.data.attributes.context) {
            var e = Math.max(this.data.attributes.outer_radius, this.data.attributes.item_size / 2); x || this.data.attributes.context.clearRect(a - e, c - e, 2 * e, 2 * e); this.config.use_background && (this.data.attributes.context.beginPath(), this.data.attributes.context.arc(a, c, this.data.attributes.radius, 0, 2 * Math.PI, !1), this.data.attributes.context.lineWidth = this.data.attributes.line_width * this.config.bg_width, this.data.attributes.context.strokeStyle =
    ...
    g.prototype.radialFade = function (a, c, b, d, e) { var f = A(b), g = this; b = .2 * (1 === d ? -1 : 1); var k; for (k = 0; 1 >= d && 0 <= d; k++) (function () { var b = "rgba(" + f.r + ", " + f.g + ", " + f.b + ", " + Math.round(10 * d) / 10 + ")"; m.setTimeout(function () { g.drawArc(a, c, b, 1) }, 50 * k) })(), d += b; m.setTimeout(function () { g.data.state.fading[e] = !1 }, 50 * k) }; g.prototype.timeLeft = function () { return this.data.paused && "number" === typeof this.data.timer ? this.data.timer : (this.data.attributes.ref_date - new Date) / 1E3 }; g.prototype.start = function () {
        m.cancelAnimationFrame(this.data.animation_frame);
        m.clearTimeout(this.data.animation_frame); var a = f(this.element).data("date"); "undefined" === typeof a && (a = f(this.element).attr("data-date")); if ("string" === typeof a) {
            var c = this.data.attributes; var b = a.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}\s[0-9]{1,2}:[0-9]{2}:[0-9]{2}$/); null !== b && 0 < b.length ? (b = a.split(" "), a = b[0].split("-"), b = b[1].split(":"), a = new Date(a[0], a[1] - 1, a[2], b[0], b[1], b[2])) : (b = Date.parse(a), isNaN(b) ? (b = Date.parse(a.replace(/-/g, "/").replace("T", " ")), a = isNaN(b) ? new Date : b) : a = b); c.ref_date =
                a
        } else "number" === typeof this.data.timer ? this.data.paused && (this.data.attributes.ref_date = (new Date).getTime() + 1E3 * this.data.timer) : (c = f(this.element).data("timer"), "undefined" === typeof c && (c = f(this.element).attr("data-timer")), "string" === typeof c && (c = parseFloat(c)), "number" === typeof c ? (this.data.timer = c, this.data.attributes.ref_date = (new Date).getTime() + 1E3 * c) : this.data.attributes.ref_date = this.config.ref_date); this.data.paused = !1; this.update.call(this)
    }; g.prototype.restart = function () {
        this.data.timer =
      !1; this.start()
    }; g.prototype.stop = function () { "number" === typeof this.data.timer && (this.data.timer = this.timeLeft(this)); this.data.paused = !0; m.cancelAnimationFrame(this.data.animation_frame) }; g.prototype.destroy = function () { this.clearListeners(); this.stop(); m.clearInterval(this.data.interval_fallback); this.data.interval_fallback = null; this.container.remove(); f(this.element).removeAttr("data-tc-id"); f(this.element).removeData("tc-id") }; g.prototype.setOptions = function (a) {
        null === this.config && (this.default_options.ref_date =
        new Date, this.config = f.extend(!0, {}, this.default_options)); f.extend(!0, this.config, a); m = this.config.use_top_frame ? window.top : window; "undefined" !== typeof m.TC_Instance_List ? w = m.TC_Instance_List : m.TC_Instance_List = w; C(m); this.data.total_duration = this.config.total_duration; if ("string" === typeof this.data.total_duration) if ("undefined" !== typeof t[this.data.total_duration]) this.data.total_duration = t[this.data.total_duration]; else if ("Auto" === this.data.total_duration) for (a = 0; a < Object.keys(this.config.time).length; a++) {
            var c =
            Object.keys(this.config.time)[a]; if (this.config.time[c].show) { this.data.total_duration = t[D[c]]; break }
    ...
    }; g.prototype.addListener = function (a, c, b) { "function" === typeof a && ("undefined" === typeof b && (b = "visible"), this.listeners[b].push({ func: a, scope: c })) }; g.prototype.notifyListeners = function (a, c, b, d) {
        for (var e = 0; e < this.listeners[d].length; e++) {
            var f =
            this.listeners[d][e]; f.func.apply(f.scope, [a, c, b])
        }
...
(function (b, e, h) {
    var f = {
        init: function (c, g) {
            this.rotatelist = c; this.options = b.extend({}, b.fn.rotator.options, g); this.options.textClass = c.attr("data-text-class"); this.item = []; for (var a = 0, d = this.rotatelist.length; a < d; a++) this.item[a] = [], this.item[a].rotateElem = c, this.item[a].terms = this.item[a].rotateElem.find("ul li"), this.item[a].animate = this.valid_anim(b(this.item[a].rotateElem).attr("data-rotate-animation").split(",")), this.item[a].area = this.item[a].rotateElem.find(".rotate-area").css({ display: "inline-block" }),
        ...
        }, rotatePlay: function (c) { var b = this; setTimeout(function () { var a = b.item[c], d = a.area.data("term") || 0; a.area.data("term", d === a.terms.length - 1 ? 0 : d + 1).html(a.terms.eq([d]).html()); b.anim(a.area, a.animate[0]); setTimeout(function () { b.anim(a.area, a.animate[1]); b.rotatePlay(c) }, a.interval) }, 1E3) }, valid_anim: function (c) { return c ? c : b("#" + this.options.interval).attr("data-rotate-animation").split(",") },
        valid_interval: function (c) { return isNaN(c) ? this.options.interval : c }, anim: function (c, b) { c.removeClass().addClass("rotate-area " + b + " " + this.options.animateClass + " " + this.options.textClass).one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend") }
    }; b.fn.rotator = function (c) { Object.create(f).init(this, c); b.data(this, "rotator", f) }; b.fn.rotator.options = { animateClass: "animated", interval: "3000", animate: "fadeInUp,fadeOutDown" }
...
(function () {
    (function (e, m, k) {
        var l, n, p, f; n = (p = -1 !== navigator.appVersion.indexOf("MSIE")) ? parseInt(navigator.appVersion.split("MSIE")[1]) : null; f = "ontouchstart" in k; l = function () {
            function d(a, b) {
                this.options = e.extend(!0, {}, this.Defaults, b); this.$element = e(a); this.$list = this.$element.find(".rd-material-tabs__list"); this.$content = this.$element.find(".rd-material-tabs__container"); this.$win = e(k); this.$doc = e(m); this.activeIndex = 0; this.settings = {
        ...
        a.$content.find("." + a.settings.itemClass))
                ...
                var b; a !== this.activeIndex && this.options.callbacks.onChangeStart &&
            this.options.callbacks.onChangeStart.call(this); b = -(this.getContentItemWidth(this) * a + this.getOption("marginContent") * a); this.setContentTranslate(this, b); this.getOption("dragList") && this.moveListTo(this, a); this.updateActive(this, a)
            }; d.prototype.canMoveCursor = function () {
                var a; a = this; a.$list.on("mouseenter", function () { a.getOption("dragList") ? a.$element.addClass("rd-material-tabs-canMove") : a.$element.removeClass("rd-material-tabs-canMove") }); a.$list.on("mouseleave", function () {
                    a.$element.removeClass("rd-material-tabs-canMove");
                    console.log(1)
                }); a.$content.on("mouseenter", function () { a.getOption("dragContent") ? a.$element.addClass("rd-material-tabs-canMove") : a.$element.removeClass("rd-material-tabs-canMove") }); a.$content.on("mouseleave", function () { a.$element.removeClass("rd-material-tabs-canMove") })
            }; d.prototype.px = function (a) { return a + "px" }; d.prototype.transform = function (a, b) {
                var c; c = {}; p && 10 > n || !1 === a.isPerspective() ? c[a.vendorName + "transform"] = "translate(" + a.px(b) + ", 0)" : c[a.vendorName + "transform"] = "translate3d(" + a.px(b) +
                  ", 0, 0)"; return c
            ...
            }; d.prototype.setContentTranslate = function (a, b) { a.setTranslate(a, a.$content.find("." + a.settings.stageClass), b) }; d.prototype.getMaxTranslate = function (a, b) { return a.$win.width() - a.getWidth(a, b.find("." + a.settings.stageClass)) }; d.prototype.setVendor = function () { this.vendorName = this.isTransform().replace(/Transform/i, ""); this.vendorName = "" !== this.vendorName ? "-" + this.vendorName.toLowerCase() + "-" : "" }; d.prototype.isStyleSupported = function (a) {
                var b, c, d; b = m.createElement("div");
                for (c in a) if (d = a[c], "undefined" !== typeof b.style[d]) return [d, c]; return !1
            }; d.prototype.isPerspective = function () { return this.isStyleSupported(["perspective", "webkitPerspective", "MozPerspective", "OPerspective", "MsPerspective"])[0] }; d.prototype.isTransform = function () { return this.isStyleSupported(["transform", "WebkitTransform", "MozTransform", "OTransform", "msTransform"])[0] }; d.prototype.getOption = function (a) {
                var b, c; if (null != this.options.responsive) {
                    for (b in this.options.responsive) b <= this.$win.width() &&
                  (c = b); return null != this.options.responsive[c][a] ? this.options.responsive[c][a] : this.options[a]
                } return this.options[a]
            }; return d
        }(); e.fn.extend({ RDMaterialTabs: function (d) { return this.each(function () { var a; a = e(this); if (!a.data("RDMaterialTabs")) return a.data("RDMaterialTabs", new l(this, d)) }) } }); return k.RDMaterialTabs = l
    })(window.jQuery, document, window); "undefined" !== typeof module && null !== module ? module.exports = window.RDMaterialTabs : "function" === typeof define && define.amd && define(["jquery"], function () { return window.RDMaterialTabs })
}).call(this);
/**
...
(function () {
    (function (h, t, r) {
        var q; q = function () {
            function g(a, e) { this.options = h.extend(!0, {}, this.Defaults, e); this.$element = h(a); this.element = a; this.$items = this.$element.find("[data-instafeed-item]"); this.unique = this.genKey(); this.nextUrl = ""; this.initialize() } g.prototype.Defaults = {
                accessToken: "", clientId: "", get: "user", tagName: "awesome", userId: "499522078", locatioId: "", sortBy: "most-recent", useHttp: !1, showLog: "false", dateFormat: {
                    seconds: "less than a minute ago", minute: "about a minute ago", minutes: " minutes ago",
                    hour: "about an hour ago", hours: " hours ago", day: "1 day ago", days: "%b/%d/%Y"
                }
            }; g.prototype.initialize = function () { if ("string" !== typeof this.options.clientId && "string" !== typeof this.options.accessToken) throw Error("Missing clientId or accessToken."); null != this.options.before && "function" === typeof this.options.before && this.options.before.call(this); this.fetchData(this, this.buildUrl(), null) }; g.prototype.fetchData = function (a, e, f) {
                var c; c = a.element.getAttribute("data-instafeed-get") ? a.element.getAttribute("data-instafeed-get") :
                  a.options.get; h.ajax({
                      type: "GET", dataType: "jsonp", cache: !1, url: e, success: function (b) {
                          var d, e; null != f ? (d = f, d.push.apply(d, b.data)) : d = b.data; null != b.pagination && (a.nextUrl = b.pagination.next_url); if ("profile" !== c) {
                              e = parseInt(a.$items.length, 10); if (d.length > e) return d = a.sorting(a, d), d = d.slice(0, e), a.validate(a, b), b = a.element.getAttribute("data-instafeed-showlog") ? a.element.getAttribute("data-instafeed-showlog") : a.options.showLog, "true" === b && console.log(d), a.loopData(d); if (null != a.nextUrl) return a.fetchData(a,
                ...
                if ("object" !== typeof e) { if (null != a.options.error && "function" === typeof a.options.error) return a.options.error.call(this, "Invalid JSON data"), !1; throw Error("Invalid JSON response"); } if (200 !== e.meta.code) {
                    if (null != a.options.error && "function" === typeof a.options.error) return a.options.error.call(this,
                    e.meta.error_message), !1; throw Error("Error from Instagram: " + e.meta.error_message);
                } if (0 === e.data.length) { if (null != a.options.error && "function" === typeof a.options.error) return a.options.error.call(this, "No images were returned from Instagram"), !1; throw Error("No images were returned from Instagram"); }
            }; g.prototype.sorting = function (a, e) {
                var f, c, b; if ("profile" !== (a.element.getAttribute("data-instafeed-get") ? a.element.getAttribute("data-instafeed-get") : a.options.get) && (c = a.element.getAttribute("data-instafeed-sort") ?
                    a.element.getAttribute("data-instafeed-sort") : a.options.sortBy, "none" !== c)) switch (b = "random" === c ? ["", "random"] : c.split("-"), f = "least" === b[0] ? !0 : !1, b[1]) { case "random": e.sort(function () { return .5 - Math.random() }); break; case "recent": e = a.sortBy(e, "created_time", f); break; case "liked": e = a.sortBy(e, "likes.count", f); break; case "commented": e = a.sortBy(e, "comments.count", f); break; default: throw Error("Invalid option for sortBy: '" + c + "'."); } return e
            }; g.prototype.loopData = function (a) {
                var e, f, c, b, d; b = this; null !=
        b.options.filter && "function" === typeof b.options.filter && (a = ctxfilter(a, b.options.filter)); if (Array.isArray(a)) for (d = 0; d < a.length;) a[d].tags_full = b.arrToString(a[d].tags), c = f = e = -1, b.$items.eq(d).find("*").each(function () {
        ...
        }), d++; else a.link = "https://www.instagram.com/" + a.username, b.$element.find("*").not("[data-instafeed-item], [data-instafeed-item] *, [data-instafeed-get]").each(function () { return b.parseAttributes(this, a, 0) }); null != b.options.after && "function" === typeof b.options.after && b.options.after.call(this); return !0
            }; g.prototype.checkAttribute = function (a, e) {
                var f, c, b, d; d = a.attributes; c = 0; for (b = d.length; c <
            b; c++) if (f = d[c], -1 < f.name.indexOf(e)) return !0; return !1
            }; g.prototype.parseAttributes = function (a, e, f) {
                var c, b, d, m, g, h, k, p, l, n; m = a.attributes; for (g in m) if (null != m[g] && "object" === typeof m[g] && -1 !== m[g].name.indexOf("data-") && -1 === m[g].name.indexOf("data-instafeed-")) {
                    n = m[g].name.substring(5); c = null; if (-1 !== n.indexOf("-")) for (p = n.split("-"), c = e, b = 0, d = p.length; b < d; b++) k = p[b], c = "data" === k && null != c[k] && null != c[k][f] ? c[k][f] : c[k]; if ("string" === typeof m[g].value && (b = m[g].value.split(/\s?,\s?/i), null != c ? l =
                        c : null != e[n] && (l = e[n]), -1 !== n.indexOf("created_time") && (h = l), null != l && null != b && ("string" === typeof l || "number" === typeof l))) for (k = 0, p = b.length; k < p; k++) c = b[k], -1 !== n.indexOf("created_time") && (l = "datetime" === c ? this.dating(h, !0) : this.dating(h, !1)), "text" === c.toLowerCase() ? a.innerHTML = l : "type" === n && "image" !== l ? a.setAttribute(c, "iframe") : (d = c.charAt(0), "0" <= d && "9" >= d || a.setAttribute(c, l))
                }
            }; g.prototype.arrToString = function (a) { return a.join(" ") }; g.prototype.dating = function (a, e) {
                var f, c, b, d, g, h; f = new Date(1E3 *
            a); c = new Date; b = parseInt((c.getTime() - f.getTime()) / 1E3); b += 60 * c.getTimezoneOffset(); c = "January February March April May June July August September October November December".split(" "); f = { "%d": f.getDate(), "%m": f.getMonth() + 1, "%b": c[f.getMonth()].substring(0, 3), "%B": c[f.getMonth()], "%y": String(f.getFullYear()).slice(-2), "%Y": f.getFullYear() }; c = e ? "%Y-%m-%d" : element.getAttribute("data-instafeed-date-format") ? element.getAttribute("data-instafeed-date-format") : this.options.dateFormat.days; if (60 > b) return this.options.dateFormat.seconds;
                if (120 > b) return this.options.dateFormat.minute; if (3600 > b) return parseInt(b / 60).toString() + this.options.dateFormat.minutes; if (7200 > b) return this.options.dateFormat.hour; if (86400 > b) return "about " + parseInt(b / 3600).toString() + this.options.dateFormat.hours; if (172800 > b) return this.options.dateFormat.day; d = c.match(/%[dmbByY]/g); g = 0; for (h = d.length; g < h; g++) b = d[g], c = c.replace(b, f[b]); return c
            }; g.prototype.sortBy = function (a, e, f) {
                a.sort(function (a, b) {
                    var d, g; d = this.getObjectProperty(a, e); g = this.getObjectProperty(b,
                      e); return f ? d > g ? 1 : -1 : d < g ? 1 : -1
                }.bind(this)); return a
            }; g.prototype.getObjectProperty = function (a, e) { var f, c; e = e.replace(/\[(\w+)\]/g, ".$1"); for (c = e.split(".") ; c.length;) if (f = c.shift(), null != a && f in a) a = a[f]; else return null; return a }; g.prototype.buildUrl = function () {
                var a, e, f, c; f = this.element.getAttribute("data-instafeed-get") ? this.element.getAttribute("data-instafeed-get") : this.options.get; switch (f) {
                    case "popular": a = "media/popular"; break; case "tagged": a = this.element.getAttribute("data-instafeed-tagname") ?
                    ...
                    this.options.userId; if (!a) throw Error("No user specified. Use the 'userId' option."); a = "users/" + a + "/media/recent"; break; case "profile": a = this.element.getAttribute("data-instafeed-user") ? this.element.getAttribute("data-instafeed-user") : this.options.userId; if (!a) throw Error("No user specified. Use the 'userId' option."); a = "users/" + a; break; default: throw Error("Invalid option for get: '" + this.options.get + "'.");
                } c = "https://api.instagram.com/v1/" + a; a = this.element.getAttribute("data-instafeed-accesstoken") ?
                ...
                var a; a = function () { return (65536 * (1 + Math.random()) | 0).toString(16).substring(1) }; return "" +
                a() + a() + a() + a()
            }; g.prototype.filter = function (a, e) { var f, c, b, d, g; f = []; c = function (a) { if (e(a)) return f.push(a) }; d = 0; for (g = a.length; d < g; d++) b = a[d], c(b); return f }; return g
        }(); h.fn.extend({ RDInstafeed: function (g) { return this.each(function () { var a; a = h(this); if (!a.data("RDInstafeed")) return a.data("RDInstafeed", new q(this, g)) }) } }); return r.RDInstafeed = q
    })(window.jQuery, document, window); "undefined" !== typeof module && null !== module ? module.exports = window.RDInstafeed : "function" === typeof define && define.amd && define(["jquery"],
    function () { return window.RDInstafeed })
}).call(this);
/**
...
(function () {
    (function (l, n, p) {
        return function () {
            function g(a, b) { this.options = l.extend(!0, {}, this.Defaults, b); this.$element = l(a); this.initialize() } g.prototype.Defaults = {
        ...
        var r; r = function () {
            function k(c, f) { this.options = g.extend(!0, {}, this.Defaults, f); this.element = c; this.$element = g(c); this.$win = g(n); this.$doc = g(t); this.$items = this.$element.find("[data-fb-post]"); this.$user = this.$element.find("[data-fb-user]"); this.initialize() } k.prototype.Defaults = { id: "", accessToken: "", showLog: !1, dateFormat: { seconds: "less than a minute ago", minute: "about a minute ago", minutes: " minutes ago", hour: "about an hour ago", hours: " hours ago", day: "1 day ago", days: "%b/%d/%Y" }, callbacks: { userLoaded: !1, postsLoaded: !1 } }; k.prototype.initialize = function () { var c, f, d, b; f = this; b = this.element.getAttribute("data-fb-id") ? this.element.getAttribute("data-fb-id") : this.options.id; c = this.element.getAttribute("data-fb-access") ? this.element.getAttribute("data-fb-access") : this.options.accessToken; if (!b) throw Error("You need to provide an user/page id!"); if (!c) throw Error("You need to provide an access token!"); d = f.$items.length; d = "https://graph.facebook.com/" + b + "/posts/?access_token=" + c + "&callback=?&date_format=U&limit=" + d; g.when(g.getJSON("https://graph.facebook.com/" + b + "/?fields=name,picture&access_token=" + c + "&callback=?"), g.getJSON(d)).done(function (a, b) { var c, d; if ("true" === f.element.getAttribute("data-fb-showlog") ? f.element.getAttribute("data-fb-showlog") : f.options.showLog) console.log("User: "), console.log(a[0]), console.log("Posts: "), console.log(b[0].data); c = a[0]; d = []; g.each(b[0].data, function () { var a, b, e, g; if (!this.message) return !0; this.from.picture = c.picture.data.url; this.message = f.urlHyperlinks(this.message); this.likes ? this.likes.count = this.likes.data.length : (this.likes = [], this.likes.count = 0); this.comments ? this.comments.count = this.comments.data.length : (this.comments = [], this.comments.count = 0); null != this.actions[0] && "Share" === this.actions[0].name && (this.postlink = this.actions[0].link); if (null != this.comments.data) for (g = this.comments.data, b = 0, e = g.length; b < e; b++) a = g[b], a.from.link = "https://facebook.com/" + a.from.id; d.push(this) }); f.loopData(c, !0); f.loopData(d, !1) }) }; k.prototype.dating = function (c, f) {
                ...
                var d, b, a, e; a = this; null != a.interval && clearInterval(a.interval); if (f) a.$user.find("*").each(function () { return a.parseAttributes(this, c, 0) }), a.options.callbacks.userLoaded && a.options.callbacks.userLoaded.call(this, a); else {
                    ...
                    }), e++; a.options.callbacks.postsLoaded && a.options.callbacks.postsLoaded.call(this, a)
                }
            }; k.prototype.checkAttribute = function (c, f) { var d, b, a, e; e = c.attributes; b = 0; for (a = e.length; b < a; b++) if (d = e[b], -1 < d.name.indexOf(f)) return !0; return !1 }; k.prototype.parseAttributes = function (c, f, d) {
                var b, a, e, h, k, q, l, m, n, p; e = c.attributes; for (h in e) if (null != e[h] && "data-remove" !== e[h].name && "object" === typeof e[h] && -1 !== e[h].name.indexOf("data-") && -1 === e[h].name.indexOf("data-fb-")) {
                    p = e[h].name.substring(5); b = null; if (-1 !== p.indexOf("-")) for (n = p.split("-"), b = f, a = 0, q = n.length; a < q; a++) l = n[a], "data" === l && null != b[l] && null != b[l][d] ? b = b[l][d] : null != b[l] ? b = b[l] : c.hasAttribute("data-remove") && g(c).remove(); if ("string" === typeof e[h].value && (a = e[h].value.split(/\s?,\s?/i), null != b ? m = b : null != f[p] && (m =
            ...
            }; k.prototype.getOption = function (c) { var f, d; if (null != this.options.responsive) { for (f in this.options.responsive) f <= n.innerWidth && (d = f); return null != this.options.responsive[d][c] ? this.options.responsive[d][c] : this.options[c] } return this.options[c] };
            return k
        }(); g.fn.extend({ RDFacebookFeed: function (k) { return this.each(function () { var c; c = g(this); if (!c.data("RDFacebookFeed")) return c.data("RDFacebookFeed", new r(this, k)) }) } }); return n.RDFacebookFeed = r
    })(window.jQuery, document, window); "undefined" !== typeof module && null !== module ? module.exports = window.RDFacebookFeed : "function" === typeof define && define.amd && define(["jquery"], function () { return window.RDFacebookFeed })
}).call(this);
/**
 * @module       RD Navbar
 * @author       Evgeniy Gusarov
 ...
 */
(function () {
    var g; g = "ontouchstart" in window; (function (c, n, l) {
        var m; m = function () {
            function d(a, b) { this.options = c.extend(!1, {}, this.Defaults, b); this.$element = c(a); this.$clone = null; this.$win = c(l); this.$doc = c(n); this.currentLayout = this.options.layout; this.loaded = !1; this.focusOnHover = this.options.focusOnHover; this.isStuck = this.cloneTimer = this.focusTimer = !1; this.initialize() } d.prototype.Defaults = {
                layout: "rd-navbar-static", deviceLayout: "rd-navbar-fixed", focusOnHover: !0, focusOnHoverTimeout: 800, linkedElements: ["html"],
                domAppend: !0, stickUp: !0, stickUpClone: !0, stickUpOffset: "100%", anchorNavSpeed: 400, anchorNavOffset: 0, anchorNavEasing: "swing", autoHeight: !0, responsive: { 0: { layout: "rd-navbar-fixed", focusOnHover: !1, stickUp: !1 }, 992: { layout: "rd-navbar-static", focusOnHover: !0, stickUp: !0 } }, callbacks: { onToggleSwitch: !1, onToggleClose: !1, onDomAppend: !1, onDropdownOver: !1, onDropdownOut: !1, onDropdownToggle: !1, onDropdownClose: !1, onStuck: !1, onUnstuck: !1, onAnchorChange: !1 }
            }; d.prototype.initialize = function () {
                this.$element.addClass("rd-navbar").addClass(this.options.layout);
                g && this.$element.addClass("rd-navbar--is-touch"); this.setDataAPI(this); this.options.domAppend && this.createNav(this); this.options.stickUpClone && this.createClone(this); this.applyHandlers(this); this.offset = this.$element.offset().top; this.height = this.$element.outerHeight(); this.loaded = !0; return this
            }; d.prototype.resize = function (a, b) {
                var e, h; h = g ? a.getOption("deviceLayout") : a.getOption("layout"); e = a.$element.add(a.$clone); h === a.currentLayout && a.loaded || (a.switchClass(e, a.currentLayout, h), null != a.options.linkedElements &&
              c.grep(a.options.linkedElements, function (b, c) { return a.switchClass(b, a.currentLayout + "-linked", h + "-linked") }), a.currentLayout = h); a.focusOnHover = a.getOption("focusOnHover"); return a
            }; d.prototype.stickUp = function (a, b) {
                var e, h, f, d; h = a.getOption("stickUp"); e = a.$doc.scrollTop(); d = null != a.$clone ? a.$clone : a.$element; f = a.getOption("stickUpOffset"); f = "string" === typeof f ? 0 < f.indexOf("%") ? parseFloat(f) * a.height / 100 : parseFloat(f) : f; if (h) {
                    if (e >= f && !a.isStuck || e < f && a.isStuck) if (a.$element.add(a.$clone).find("[data-rd-navbar-toggle]").each(function () {
                    c.proxy(a.closeToggle,
                            this)(a, !1)
                    }).end().find(".rd-navbar-submenu").removeClass("opened").removeClass("focus"), e >= f && !a.isStuck) "resize" === b.type ? a.switchClass(d, "", "rd-navbar--is-stuck") : d.addClass("rd-navbar--is-stuck"), a.isStuck = !0, a.options.callbacks.onStuck && a.options.callbacks.onStuck.call(a); else {
                        if ("resize" === b.type) a.switchClass(d, "rd-navbar--is-stuck", ""); else d.removeClass("rd-navbar--is-stuck").one("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd", c.proxy(a.resizeWrap, a, b)); a.isStuck = !1; a.options.callbacks.onUnstuck &&
                a.options.callbacks.onUnstuck.call(a)
                    }
                } else a.isStuck && (a.switchClass(d, "rd-navbar--is-stuck", ""), a.isStuck = !1, a.resizeWrap(b)); return a
            }; d.prototype.resizeWrap = function (a) {
                var b; if (null == this.$clone && !this.isStuck) {
                    b = this.$element.parent(); if (this.getOption("autoHeight")) return this.height = this.$element.outerHeight(), "resize" === a.type ? (b.addClass("rd-navbar--no-transition").css("height", this.height), b[0].offsetHeight, b.removeClass("rd-navbar--no-transition")) : b.css("height", this.height); b.css("height",
                        "auto")
                }
            }; d.prototype.createNav = function (a) { a.$element.find(".rd-navbar-dropdown, .rd-navbar-megamenu").each(function () { var a; a = c(this); return a.hasClass("rd-navbar-megamenu") ? a.parent().addClass("rd-navbar--has-megamenu") : a.parent().addClass("rd-navbar--has-dropdown") }).parents("li").addClass("rd-navbar-submenu").append(c("<span/>", { "class": "rd-navbar-submenu-toggle" })); a.options.callbacks.onDomAppend && a.options.callbacks.onDomAppend.call(this); return a }; d.prototype.createClone = function (a) {
                a.$clone =
                a.$element.clone().insertAfter(a.$element).addClass("rd-navbar--is-clone"); return a
            }; d.prototype.closeToggle = function (a, b) {
                var e, d, f; e = c(b.target); d = !1; b.target !== this && !e.parents("[data-rd-navbar-toggle]").length && (f = this.getAttribute("data-rd-navbar-toggle")) && (e = c(this).parents(".rd-navbar").find(f).add(c(this).parents(".rd-navbar")[0]), e.each(function () { if (!d) return d = !0 === (b.target === this || c.contains(this, b.target)) }), d || (e.add(this).removeClass("active"), a.options.callbacks.onToggleClose && a.options.callbacks.onToggleClose.call(this,
                a))); return this
            }; d.prototype.switchToggle = function (a, b) {
                var e; b.preventDefault(); if (e = this.getAttribute("data-rd-navbar-toggle")) c("[data-rd-navbar-toggle]").not(this).each(function () { var a; if (a = this.getAttribute("data-rd-navbar-toggle")) return c(this).parents(".rd-navbar").find(a).add(this).add(-1 < c.inArray(".rd-navbar", a.split(/\s*,\s*/i)) ? c(this).parents(".rd-navbar")[0] : !1).removeClass("active") }), c(this).parents(".rd-navbar").find(e).add(this).add(-1 < c.inArray(".rd-navbar", e.split(/\s*,\s*/i)) ?
                c(this).parents(".rd-navbar")[0] : !1).toggleClass("active"), a.options.callbacks.onToggleSwitch && a.options.callbacks.onToggleSwitch.call(this, a); return this
            }; d.prototype.dropdownOver = function (a, b) { var e; a.focusOnHover && !g && (e = c(this), clearTimeout(b), e.addClass("focus").siblings().removeClass("opened").each(a.dropdownUnfocus), a.options.callbacks.onDropdownOver && a.options.callbacks.onDropdownOver.call(this, a)); return this }; d.prototype.dropdownOut = function (a, b) {
                var e; a.focusOnHover && !g && (e = c(this), e.one("mouseenter.navbar",
                function () { return clearTimeout(b) }), clearTimeout(b), b = setTimeout(c.proxy(a.dropdownUnfocus, this, a), a.options.focusOnHoverTimeout), a.options.callbacks.onDropdownOut && a.options.callbacks.onDropdownOut.call(this, a)); return this
            }; d.prototype.dropdownUnfocus = function (a) { c(this).find("li.focus").add(this).removeClass("focus"); return this }; d.prototype.dropdownClose = function (a, b) {
                var e; b.target === this || c(b.target).parents(".rd-navbar-submenu").length || (e = c(this), e.find("li.focus").add(this).removeClass("focus").removeClass("opened"),
            a.options.callbacks.onDropdownClose && a.options.callbacks.onDropdownClose.call(this, a)); return this
            }; d.prototype.dropdownToggle = function (a) { c(this).toggleClass("opened").siblings().removeClass("opened"); a.options.callbacks.onDropdownToggle && a.options.callbacks.onDropdownToggle.call(this, a); return this }; d.prototype.goToAnchor = function (a, b) {
                var e, d; d = this.hash; e = c(d); e.length && (b.preventDefault(), c("html, body").stop().animate({ scrollTop: e.offset().top + a.getOption("anchorNavOffset") + 1 }, a.getOption("anchorNavSpeed"),
                    a.getOption("anchorNavEasing"), function () { return a.changeAnchor(d) })); return this
            }; d.prototype.activateAnchor = function (a) {
                var b, e, d, f, g, k; k = this.$doc.scrollTop(); g = this.$win.height(); b = this.$doc.height(); a = this.getOption("anchorNavOffset"); if (k + g > b - 50) return b = c('[data-type="anchor"]').last(), b.length && b.offset().top >= k && (f = "#" + b.attr("id"), e = c('.rd-navbar-nav a[href^="' + f + '"]').parent(), e.hasClass("active") || (e.addClass("active").siblings().removeClass("active"), this.options.callbacks.onAnchorChange &&
            this.options.callbacks.onAnchorChange.call(b[0], this))), b; g = c('.rd-navbar-nav a[href^="#"]').get(); for (e in g) b = g[e], d = c(b), f = d.attr("href"), b = c(f), b.length && b.offset().top + a <= k && b.offset().top + b.outerHeight() > k && (d.parent().addClass("active").siblings().removeClass("active"), this.options.callbacks.onAnchorChange && this.options.callbacks.onAnchorChange.call(b[0], this)); return null
            }; d.prototype.getAnchor = function () { return history && history.state ? history.state.id : null }; d.prototype.changeAnchor = function (a) {
                history &&
                (history.state ? history.state.id !== a ? history.replaceState({ anchorId: a }, null, a) : history.pushState({ anchorId: a }, null, a) : history.pushState({ anchorId: a }, null, a)); return this
            }; d.prototype.applyHandlers = function (a) {
                null != a.options.responsive && a.$win.on("resize.navbar", c.proxy(a.resize, a.$win[0], a)).on("resize.navbar", c.proxy(a.resizeWrap, a)).on("resize.navbar", c.proxy(a.stickUp, null != a.$clone ? a.$clone : a.$element, a)).on("orientationchange.navbar", c.proxy(a.resize, a.$win[0], a)).trigger("resize.navbar"); a.$doc.on("scroll.navbar",
                    c.proxy(a.stickUp, null != a.$clone ? a.$clone : a.$element, a)).on("scroll.navbar", c.proxy(a.activateAnchor, a)); a.$element.add(a.$clone).find("[data-rd-navbar-toggle]").each(function () { var b; b = c(this); b.on(g ? "touchstart" : "click", c.proxy(a.switchToggle, this, a)); return b.parents("body").on(g ? "touchstart" : "click", c.proxy(a.closeToggle, this, a)) }); a.$element.add(a.$clone).find(".rd-navbar-submenu").each(function () {
                        var b, e; b = c(this); e = b.parents(".rd-navbar--is-clone").length ? a.cloneTimer : a.focusTimer; b.on("mouseleave.navbar",
                        c.proxy(a.dropdownOut, this, a, e)); b.find("> a").on("mouseenter.navbar", c.proxy(a.dropdownOver, this, a, e)); b.find("> .rd-navbar-submenu-toggle").on("click", c.proxy(a.dropdownToggle, this, a)); return b.parents("body").on(g ? "touchstart" : "click", c.proxy(a.dropdownClose, this, a))
                    }); a.$element.add(a.$clone).find('.rd-navbar-nav a[href^="#"]').each(function () { return c(this).on(g ? "touchstart" : "click", c.proxy(a.goToAnchor, this, a)) }); return a
            }; d.prototype.switchClass = function (a, b, e) {
                a = a instanceof jQuery ? a : c(a);
                a.addClass("rd-navbar--no-transition").removeClass(b).addClass(e); a[0].offsetHeight; return a.removeClass("rd-navbar--no-transition")
            }; d.prototype.setDataAPI = function (a) {
                var b, c, d, f; a = ["-", "-xs-", "-sm-", "-md-", "-lg-"]; f = [0, 480, 768, 992, 1200]; b = c = 0; for (d = f.length; c < d; b = ++c) this.$element.attr("data" + a[b] + "layout") && (this.options.responsive[f[b]] || (this.options.responsive[f[b]] = {}), this.options.responsive[f[b]].layout = this.$element.attr("data" + a[b] + "layout")), this.$element.attr("data" + a[b] + "device-layout") &&
            ...
            }; d.prototype.getOption = function (a) { var b, c; for (b in this.options.responsive) b <= l.innerWidth && (c = b); return null != this.options.responsive && null != this.options.responsive[c][a] ? this.options.responsive[c][a] : this.options[a] }; return d
        }(); c.fn.extend({
            RDNavbar: function (d) {
                var a;
                a = c(this); if (!a.data("RDNavbar")) return a.data("RDNavbar", new m(this, d))
            }
        }); return l.RDNavbar = m
    })(window.jQuery, document, window); "undefined" !== typeof module && null !== module ? module.exports = window.RDNavbar : "function" === typeof define && define.amd && define(["jquery"], function () { return window.RDNavbar })
}).call(this);
/**
 * @module       Swiper 3.1.7
...
(function () {
    (function (n, m, e) {
        var r, x, u, w, k, h, v, p; h = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent); u = /Chrome/.test(navigator.userAgent); p = /Chrome/.test(navigator.userAgent) && /Google Inc/.test(navigator.vendor) || /Safari/.test(navigator.userAgent) && /Apple Computer/.test(navigator.vendor); w = h && /crios/i.test(navigator.userAgent); v = /iPhone|iPad|iPod/i.test(navigator.userAgent) && !!navigator.userAgent.match(/Version\/[\d\.]+.*Safari/); k = -1 !== navigator.appVersion.indexOf("MSIE") ||
            0 < navigator.appVersion.indexOf("Trident/"); x = null != m.body.classList; (function () {
                var h, k, m, b, a; k = 0; a = ["ms", "moz", "webkit", "o"]; h = 0; for (m = a.length; h < m; h++) b = a[h], e.requestAnimationFrame = e[b + "RequestAnimationFrame"], e.cancelAnimationFrame = e[b + "CancelAnimationFrame"] || e[b + "CancelRequestAnimationFrame"]; e.requestAnimationFrame || (e.requestAnimationFrame = function (a, c) { var d, b, g; d = (new Date).getTime(); g = Math.max(0, 16 - (d - k)); b = e.setTimeout(function () { a(d + g) }, g); k = d + g; return b }); if (!e.cancelAnimationFrame) return e.cancelAnimationFrame =
                function (a) { return clearTimeout(a) }
            }); r = function () {
                function t(b) { this.options = n.extend(!0, {}, this.Defaults, b); this.scenes = []; this.initialize(); this.scrollY = e.scrollY || e.pageYOffset; this.lastScrollY = -1; this.inputFocus = !1 } var y, r; y = function () {
                    function b(a, f, c, d, b, g, l) {
                        this.amend = p || k || h ? 60 : 0; this.element = a; this.aliases = f; this.type = a.getAttribute("data-type") || "html"; "html" === this.type && (this.holder = this.createHolder()); this.direction = "normal" === a.getAttribute("data-direction") || null == a.getAttribute("data-direction") ?
                        ...
                        this.speed = this.getOption("speed", a) || 0; this.offset = this.getOption("offset", a) || 0; !h || u && h || (this.element.style.position = b ? "fixed" : "absolute"); k && "html" === this.type && (this.element.style.position = "absolute"); switch (this.type) {
                            case "media": if (!k) return this.offsetHeight = this.getMediaHeight(f, d, this.speed, this.direction), this.element.style.height = this.offsetHeight + "px"; break; case "html": this.element.style.width = this.holder.offsetWidth + "px"; this.offsetHeight =
                        ...
                        var a; a = m.createElement("div"); x ? a.classList.add("rd-parallax-layer-holder") : a.className =
                        "rd-parallax-layer-holder"; this.element.parentNode.insertBefore(a, this.element); a.appendChild(this.element); if (!k && !h || w) a.style.position = "relative"; return a
                    }; b.prototype.getOption = function (a, f) { var c, d; for (c in this.responsive) c <= f && (d = c); return this.responsive[d][a] }; b.prototype.getResponsiveOptions = function () {
                        var a, f, c, d, b, g, l, e, h; e = {}; l = []; f = []; d = this.aliases; for (c in d) a = d[c], l.push(c), f.push(a); c = d = 0; for (b = l.length; d < b; c = ++d) for (g = l[c], e[g] = {}; -1 <= (a = c) ;) !e[g].speed && (h = this.element.getAttribute("data" +
                        f[a] + "speed")) && (e[g].speed = this.getSpeed(h)), !e[g].offset && (h = this.element.getAttribute("data" + f[a] + "offset")) && (e[g].offset = parseInt(h)), c--; return e
                    }; b.prototype.fuse = function (a, f) { var c, d, b; c = this.getOffset(this.element).top + this.element.getBoundingClientRect().top; d = a + f / 2; c += this.offsetHeight / 2; b = f / 6; d + b > c && d - b < c ? this.element.style.opacity = 1 : (d = d - b < c ? 1 + (d + b - c) / f / 3 * 10 : 1 - (d - b - c) / f / 3 * 10, this.element.style.opacity = 0 > d ? 0 : 1 < d ? 1 : d.toFixed(2)) }; b.prototype.move = function (a, f, c, d, b, g, e, q, m) {
                        k && "media" ===
                ...
                function () {
                    function b(a, b, c, d) { this.amend = p ? 60 : 0; this.element = a; this.aliases = b; this.on = !0; this.agent = m.querySelector(a.getAttribute("data-agent")); this.anchor = this.findAnchor(); this.canvas = this.createCanvas(); this.layers = this.createLayers(c); this.fitTo = this.getFitElement(); this.responsive = this.getResponsiveOptions(); this.refresh(c, d) } b.prototype.getFitElement = function () { var a; return null != (a = this.element.getAttribute("data-fit-to")) ? "parent" === a ? this.element.parentNode : m.querySelector(a) : null }; b.prototype.findAnchor =
                        function () { var a; for (a = this.element.parentNode; null != a && a !== m;) { if (this.isTransformed.call(a)) return a; a = a.parentNode } return null }; b.prototype.createCanvas = function () {
                            var a; a = m.createElement("div"); x ? a.classList.add("rd-parallax-inner") : a.className = "rd-parallax-inner"; for (this.element.appendChild(a) ; this.element.firstChild !== a;) a.appendChild(this.element.firstChild); this.element.style.position = "relative"; this.element.style.overflow = "hidden"; k || h ? (a.style.position = "absolute", a.style.clip = "rect(0, auto, auto, 0)",
                            a.style.transform = k ? "translate3d(0,0,0)" : "none") : a.style.position = "fixed"; a.style.left = this.offsetLeft + "px"; a.style.top = 0; p && (a.style["margin-top"] = "-" + this.amend + "px", a.style.padding = this.amend + "px 0", this.element.style["z-index"] = 0); return a
                        }; b.prototype.getOption = function (a, b) { var c, d; for (c in this.responsive) c <= b && (d = c); return this.responsive[d][a] }; b.prototype.getResponsiveOptions = function () {
                            var a, b, c, d, e, g, l, h, k; h = {}; l = []; b = []; d = this.aliases; for (c in d) a = d[c], l.push(c), b.push(a); c = d = 0; for (e =
                                                                                                                                    l.length; d < e; c = ++d) for (g = l[c], h[g] = {}; -1 <= (a = c) ;) h[g].on || null == (k = this.element.getAttribute("data" + b[a] + "on")) || (h[g].on = "false" !== k), null == h[g].on && 0 === a && (h[g].on = !0), c--; return h
                        }; b.prototype.createLayers = function (a, b) { var c, d, e, g, h; d = n(this.element).find(".rd-parallax-layer").get(); g = []; c = e = 0; for (h = d.length; e < h; c = ++e) c = d[c], g.push(new y(c, this.aliases, a, b, this.offsetTop, this.offsetHeight, this.on)); return g }; b.prototype.move = function (a) {
                            a = null != this.anchor ? this.positionTop : this.offsetTop - a; p &&
(this.canvas.style["-webkit-transform"] = "translate3d(0," + a + "px,0)"); return this.canvas.style.transform = "translate3d(0," + a + "px,0)"
                            ...
                            var c, d, e, g, h; g = []; this.on = this.getOption("on", a); this.offsetTop = this.getOffset(this.element).top; this.offsetLeft = this.getOffset(this.element).left; this.width = this.element.offsetWidth; this.canvas.style.width = this.width + "px"; null != this.anchor && (this.positionTop = this.element.offsetTop); null != this.agent ? (this.agentOffset = this.getOffset(this.agent).top,
                                this.agentHeight = this.agent.offsetHeight) : this.agentOffset = this.agentHeight = null; h = this.layers; c = 0; for (e = h.length; c < e; c++) d = h[c], "media" === d.type ? g.push(d) : d.refresh(a, b, this.offsetTop, this.offsetHeight, this.on); this.offsetHeight = this.canvas.offsetHeight - 2 * this.amend; this.element.style.height = this.offsetHeight + "px"; c = 0; for (e = g.length; c < e; c++) d = g[c], d.refresh(a, b, this.offsetTop, this.offsetHeight, this.on)
                        }; b.prototype.update = function (a, b, c, d, e) {
                            var g, l, m, n, p, t, r; r = this.offsetTop; t = this.offsetHeight;
                            k || h || this.move(a); n = this.layers; p = []; g = 0; for (m = n.length; g < m; g++) l = n[g], l.move(a, b, c, r, t, d, this.on, this.agentOffset, e), !l.fade || h || k ? p.push(void 0) : p.push(l.fuse(r, t)); return p
                        }; b.prototype.isTransformed = function () {
                            var a, b, c; c = { webkitTransform: "-webkit-transform", OTransform: "-o-transform", msTransform: "-ms-transform", MozTransform: "-moz-transform", transform: "transform" }; for (a in c) c.hasOwnProperty(a) && null != this.style[a] && (b = e.getComputedStyle(this).getPropertyValue(c[a])); return null != b && 0 < b.length &&
                          "none" !== b ? !0 : !1
                        }; b.prototype.getOffset = function (a) { a = a.getBoundingClientRect(); return { top: a.top + (e.scrollY || e.pageYOffset), left: a.left + (e.scrollX || e.pageYOffset) } }; return b
                }(); t.prototype.Defaults = { selector: ".rd-parallax", screenAliases: { 0: "-", 480: "-xs-", 768: "-sm-", 992: "-md-", 1200: "-lg-", 1920: "-xl-", 2560: "-xxl-" } }; t.prototype.initialize = function () {
                    var b, a, f, c, d, h, g; b = this; f = m.querySelectorAll(b.options.selector); g = e.innerWidth; h = e.innerHeight; a = c = 0; for (d = f.length; c < d; a = ++c) a = f[a], b.scenes.push(new r(a,
                    b.options.screenAliases, g, h)); n(e).on("resize", n.proxy(b.resize, b)); if (v) n("input").on("focusin focus", function (a) { a.preventDefault(); b.activeOffset = n(this).offset().top; return e.scrollTo(e.scrollX || e.pageXOffset, b.activeOffset - this.offsetHeight - 100) }); n(e).trigger("resize"); b.update()
                }; t.prototype.resize = function () {
                    var b, a, f, c; if ((b = e.innerWidth) !== this.windowWidth || !h) {
                        this.windowWidth = b; this.windowHeight = e.innerHeight; this.documentHeight = m.body.offsetHeight; f = this.scenes; b = 0; for (a = f.length; b < a; b++) c =
                        f[b], c.refresh(this.windowWidth, this.windowHeight); return this.update(!0)
                    }
                }; t.prototype.update = function (b) {
                    var a, f, c, d, k, g, l, q, n, p; f = this; b || requestAnimationFrame(function () { f.update() }); q = e.scrollY || e.pageYOffset; v && null != (a = m.activeElement) && (a.tagName.match(/(input)|(select)|(textarea)/i) ? (f.activeElement = a, f.inputFocus = !0) : (f.activeElement = null, f.inputFocus = !1, b = !0)); h && u && (a = e.innerHeight - f.windowHeight, f.deltaHeight = a, q -= f.deltaHeight); if ((q !== f.lastScrollY || b) && !f.isActing) {
                        f.isActing = !0; p =
                        f.windowWidth; n = f.windowHeight; c = f.documentHeight; a = q - f.lastScrollY; v && null != f.activeElement && (f.activeElement.value += " ", f.activeElement.value = f.activeElement.value.trim()); g = f.scenes; d = 0; for (k = g.length; d < k; d++) l = g[d], (f.inputFocus || b || q + n >= (l.agentOffset || l.offsetTop) + a && q <= (l.agentOffset || l.offsetTop) + (l.agentHeight || l.offsetHeight) + a) && l.update(q, p, n, c, f.inputFocus); f.lastScrollY = q; return f.isActing = !1
                    }
                }; return t
            }(); n.RDParallax = function (e) {
                var h; h = n(m); if (!h.data("RDParallax")) return h.data("RDParallax",
                new r(e))
            }; return e.RDParallax = r
    })(window.jQuery, document, window); "undefined" !== typeof module && null !== module ? module.exports = window.RDParallax : "function" === typeof define && define.amd && define(["jquery"], function () { return window.RDParallax })
}).call(this);
/**
 * @module       RD Video
 * @author       Rafael Shayvolodyan
...
(function () {
    (function (g, m, u) {
        var q, v, h; h = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent); v = 0 <= navigator.platform.toUpperCase().indexOf("MAC"); q = function () {
            function d(a, c) {
                this.options = g.extend(!0, {}, this.Defaults, c); this.$element = g(a); this.$win = g(u); this.$doc = g(m); this.interval = null; this.classNames = { playBtn: '[data-rd-video-btn="play"]', muteBtn: '[data-rd-video-btn="mute"]', playing: "playing", paused: "paused", muted: "muted" }; this.$playBtn = this.$element.find(this.classNames.playBtn);
                this.$muteBtn = this.$element.find(this.classNames.muteBtn); this.initialize()
            } d.prototype.Defaults = { position: "50% 50%", volume: .5, playbackRate: 1, muted: !0, loop: !0, autoplay: !0, fps: 30, transitionTime: 300, posterType: "jpg", path: "video/video", background: !0, controls: !1, hideWhenSlow: !1, imgSize: { xs: "", sm: "", md: "", lg: "", xlg: "" }, onLoad: !1 }; d.prototype.initialize = function () {
                ...
                var c, b, f, k, e, d; c = a.split(/\s+/); d = e = "50%"; b = f = 0; for (k =
                                                                       c.length; f < k; b = ++f) a = c[b], "left" === a ? e = "0%" : "right" === a ? e = "100%" : "top" === a ? d = "0%" : "bottom" === a ? d = "100%" : "center" === a ? 0 === b ? e = "50%" : d = "50%" : 0 === b ? e = a : d = a; return { x: e, y: d }
            }; d.prototype.getConnectionSpeed = function (a, c) { var b, f, k; b = this; a += "-" + b.suffix + "." + b.options.posterType; f = new Image; f.onload = function () { var a; a = Date.now(); b.speed = Math.round(b.imgSize[b.suffix] / ((a - k) / 1E3)); return c() }; k = Date.now(); a += "?t=" + k; setTimeout(function () { f.src = a; return k = Date.now() }, 300) }; d.prototype.getVideoSuffix = function (a) {
                return 50 >
a ? "xs" : 100 > a ? "sm" : 200 > a ? "md" : 800 > a ? "lg" : "xlg"
                ...
                var c, b, f, k, e, d, h, l, n, p, m; k = a.options; l = ""; f = !1; b = ["xs", "sm", "md", "lg", "xlg"]; p = a.getSuffixArray(); if (null != a.$video) for (e = d = 0, h = p.length; d < h; e = ++d) { if (m = p[e], m === a.suffix) { if (0 !== e) n = p[e - 1]; else if (a.hideWhenSlow) { a.removeVideo(a); return } break } } else n = a.getVideoSuffix(a.speed); for (; -1 === p.indexOf(n) ;) if (e = b.indexOf(n), 0 !== e) n = b[e - 1]; else return; a.suffix = n; b = a.path + "-" + n; if ("undefined" !== typeof b) {
                    ...
                    k.autoplay); p = this.$element.attr("data-rd-video-volume") ? a.$element.attr("data-rd-video-volume") : k.volume; l = this.$element.attr("data-rd-video-muted") ? "true" === a.$element.attr("data-rd-video-muted") : k.muted; b = this.$element.attr("data-rd-video-pbrate") ? a.$element.attr("data-rd-video-pbrate") : k.playbackRate; k = this.$element.attr("data-rd-video-controls") ? "true" === a.$element.attr("data-rd-video-controls") : k.controls; try {
                        c.prop({
                            autoplay: f, volume: null != a.$video2 ? a.$video[0].volume : p, muted: null != a.$video2 ?
                            a.$video.prop("muted") : l, defaultMuted: null != a.$video2 ? a.$video.prop("muted") : l, playbackRate: null != a.$video2 ? a.$video.prop("playbackRate") : b, defaultPlaybackRate: null != a.$video2 ? a.$video.prop("playbackRate") : b, controls: null != a.$video2 ? a.$video.prop("controls") : k
                        })
                    } catch (q) { throw Error("Not implemented"); } a.started = !1; a.applyListeners(a, c); a.$wrapper.append(c)
                }
            }; d.prototype.applyListeners = function (a, c) {
                var b, f, d; d = c[0]; a.tmp = null != a.$video2 ? !1 : !0; f = 0; b = a.options.fps - a.options.fps / 4; c.one("canplaythrough.rd.video",
                ...
                function () { a.$video[0].muted ? a.$element.addClass(a.classNames.muted) : a.$element.removeClass(a.classNames.muted) }).on("loadeddata.rd.video", function () { h || a.$element.removeClass("loading"); if (null != a.time) return d.currentTime = a.time, a.play() }); c.on("timeupdate.rd.video", function () {
                    var e; h && a.$element.removeClass("loading"); if (null == a.time) {
                        v && !a.started && a.resize(); a.started = !0; a.$element.hasClass("loading") && a.$element.removeClass("loading"); if (h) return c.currentTime = 0, c.css({
                            visibility: "visible",
                            opacity: 1
                        }), a.resize(); null != a.$video2 && !a.tmp && a.isBG ? (a.$video2[0].currentTime = a.$video[0].currentTime, a.replaceVideo(a), a.tmp = !0, f = 0) : (e = d.currentTime, 0 === f && (f = e, null === a.$video2 && (f += 3)), e > f + 1.5 && a.tmp && null != a.fps && a.fps < b && 0 !== a.fps && (a.createVideo(a), a.tmp = !1, c.off("timeupdate.rd.video")))
                    }
                })
            }; d.prototype.applyPlayButton = function () { var a; a = this; a.$playBtn.on("click touchstart", function (c) { a.started || a.$element.addClass("loading"); c.preventDefault(); return a.$video[0].paused ? a.play() : a.pause() }) };
            d.prototype.applyMuteButton = function () { var a; a = this; a.$muteBtn.on("click touchstart", function (c) { c.preventDefault(); return a.$video.prop("muted") ? a.unmute() : a.mute() }) }; d.prototype.changeQuality = function (a, c) {
                ...
                var a, c, b, f, d, e, r, t; b = this; t = b.getSuffixArray(); a = b.$context; c = "<h6>Quality:</h6><ul>"; f = 0; for (d = t.length; f < d; f++) r = t[f], e = b.getQualityText(r), c = r === b.suffix ? c + ('<li class="active" data-rd-quality="' + r + '">' + e + "</li>") : c + ('<li data-rd-quality="' + r + '">' + e + "</li>"); c += "</ul>"; a.find(".rd-video-context").append(c);
                a.find("[data-rd-quality]").on("click", function (c) { c = g(this); a.removeClass("show"); h && a.appendTo(b.$wrapper); c.hasClass("active") || (a.find(".active").removeClass("active"), g(this).addClass("active"), b.changeQuality(b, this.getAttribute("data-rd-quality"))) }); h ? (b.timeout = null, b.$doc.on("touchstart", function (c) { 0 === g(c.target).parents(".rd-video-context").length && (a.removeClass("show"), a.appendTo(b.$wrapper)) }), b.$video.on("touchstart", function (c) {
                    m.fullscreen || m.mozFullScreen || m.webkitIsFullScreen ||
                    m.msFullscreenElement || (b.timeout = setTimeout(function () { a.appendTo("body"); return setTimeout(function () { return a.addClass("show") }, 10) }, 300))
                }), b.$doc.on("touchend", function (a) { clearTimeout(b.timeout) })) : (b.$doc.on("contextmenu", function (c) { if (!g(c.target).is(b.$video)) return a.removeClass("show") }), b.$doc.on("click", function (b) { return a.removeClass("show") }), b.$video.on("contextmenu", g.proxy(b.onContext, this, b)))
            }; d.prototype.onContext = function (a, c) {
                var b, f, d, e, g, h, l, n, p, m, q; c.preventDefault(); b =
                a.$context; l = a.$element.offset().top; h = a.$element.offset().left; n = a.$element.outerWidth(); g = a.$element.outerHeight(); d = b.find(".rd-video-context").outerWidth(); f = b.find(".rd-video-context").outerHeight(); p = a.$win.height(); m = c.pageX; q = c.pageY; e = c.clientY; l = q - l; h = m - h; if (l + f > g && 0 < e - f || e + f > p && 0 < l - f) b.css({ top: "auto", bottom: g - l }); else if (e + f < p && l + f < g) b.css({ top: l, bottom: "auto" }); else { b.removeClass("show"); return } h + d > n ? b.css({ left: "auto", right: n - h }) : b.css({ left: h, right: "auto" }); b.addClass("show")
            }; d.prototype.getQualityText =
            function (a) { switch (a) { case "xs": return "240p"; case "sm": return "360p"; case "md": return "480p"; case "lg": return "720p"; case "xlg": return "1080p"; default: return "" } }; d.prototype.onScroll = function (a) {
                var c, b, d, k; d = a.$win.scrollTop(); b = a.$element.offset().top; c = a.$element.outerHeight(); k = a.$win.height(); a.isBG || a.$context.removeClass("show"); b < d + k && b + c > d ? a.$element.hasClass("viewport-stopped") && a.$element.hasClass(this.classNames.paused) && (a.play(), a.$element.removeClass("viewport-stopped")) : a.$element.hasClass(this.classNames.playing) &&
              (a.pause(), a.$element.addClass("viewport-stopped"))
            }; d.prototype.play = function () { this.$video[0].play(); null != this.$video2 && this.$video2[0].play() }; d.prototype.pause = function () { this.$video[0].pause(); null != this.$video2 && this.$video2[0].pause() }; d.prototype.mute = function () { this.$video.prop("muted", !0); null != this.$video2 && this.$video2.prop("muted", !0) }; d.prototype.unmute = function () { this.$video.prop("muted", !1); null != this.$video2 && this.$video2.prop("muted", !1) }; d.prototype.removeVideo = function (a) {
                clearInterval(a.interval);
                a.$video.remove(); a.$video = null
            }; d.prototype.replaceVideo = function (a) { null != a.$video2 && (clearInterval(a.interval), a.$video2.addClass("transition"), a.$video2.css({ visibility: "visible", opacity: 1 }), setTimeout(function () { a.fps = null; a.$video.remove(); a.$video = a.$video2; a.getFPS(a, a.$video[0]); a.$video.on("contextmenu", g.proxy(a.onContext, this, a)); a.$video2 = null; return a.tmp = !0 }, a.options.transitionTime)) }; d.prototype.getFPS = function (a, c) {
                var b, d, k, e; e = b = d = 0; k = c.currentTime; a.fps = 0; a.interval = setInterval(function () {
                    var g;
                    if (!c.paused) { g = c.currentTime; if (g === k) return k = -1, null; 5E3 < e && (e = b = 0); g !== d && (d = g, b++); e += 1E3 / a.options.fps; return a.fps = Math.round(b / e * 1E3) }
                }, 1E3 / a.options.fps); return null
            }; d.prototype.resize = function () { this.resizeVideo(this.$video); null != this.$video2 && this.resizeVideo(this.$video2) }; d.prototype.resizeVideo = function (a) {
                var c, b, d, g, e; c = this.$wrapper; g = c.outerHeight(); e = c.outerWidth(); c = a[0]; b = c.videoHeight; d = c.videoWidth; 0 !== b && 0 !== d && (e / d > g / b ? (a.css({ width: e, left: 0, height: "auto" }), a.css({
                    top: (g -
                  c.offsetHeight) * (parseInt(this.position.y.replace("%", "")) / 100)
                })) : (a.css({ width: "auto", height: g, top: 0 }), a.css({ left: (e - c.offsetWidth) * (parseInt(this.position.x.replace("%", "")) / 100) })))
                ...
                var a; if (null != this.path) return a = this.$win.width(), 1600 < a && this.imgSize.xlg.length ? "xlg" : 1199 < a && this.imgSize.lg.length ? "lg" : 991 < a && this.imgSize.md.length ?
        ...
        }(); g.fn.extend({ RDVideo: function (d) { return this.each(function () { var a; a = g(this); if (!a.data("RDVideo")) return a.data("RDVideo", new q(this, d)) }) } }); return u.RDVideo = q
    })(window.jQuery, document, window);
    "undefined" !== typeof module && null !== module ? module.exports = window.RDVideo : "function" === typeof define && define.amd && define(["jquery"], function () { return window.RDVideo })
}).call(this);
/**
...
(function () {
    (function (f, k, l) {
        var m, g; navigator.appVersion.indexOf("MSIE"); g = "ontouchstart" in l; m = function () {
            function d(a, b) {
                this.options = f.extend(!0, {}, this.Defaults, b); this.element = a; this.$element = f(a); this.state = 0; this.$win = f(l); this.$doc = f(k); this.classes = {
            ...
            d.prototype.updateState = function (a) { var b; b = a.isErrored() ? 0 : a.isLoading() ? 1 : 2; a.state !== b && (a.state = b) }; d.prototype.attachPlayPauseButtonListener = function () { var a; a = this; a.$element.find("." + a.classes.playPause).on("click", function (b) { b.preventDefault(); 2 === a.state && null == a.playListName && (a.isPlaying() ? a.audio.pause() : a.audio.play()); a.$doc.trigger("playlistClick", [a.playListName, a.index]) }) }; d.prototype.attachStopButtonListener = function () {
                var a; a = this; a.$element.find("." + a.classes.stopButton).on("click",
                    function (b) { b.preventDefault(); a.audio.currentTime = 0; a.$doc.trigger("playlistClick", [a.playListName, a.index]) })
            }; d.prototype.updateDuration = function () { var a, b; a = this; (b = a.$element.find("." + a.classes.duration)[0]) && a.audio.addEventListener("durationchange", function () { var c, e; c = a.getDuration(); e = ("0" + Math.floor(c)).slice(-2); c = ("0" + Math.floor(e / 60 % 60)).slice(-2); return b.innerHTML = c + ":" + Math.floor(e) }) }; d.prototype.updateAuthorName = function () {
                var a, b; b = this; (a = b.$element.find("." + b.classes.author)[0]) &&
            b.audio.addEventListener("durationchange", function () { var c; b.playListName ? (c = b.$doc.find('[data-rd-audio-playlist="' + b.playListName + '"]:not(.' + b.classes.playlist + ') li[data-index="' + b.index + '"]'), c = c[0].getAttribute("data-rd-audio-author")) : c = b.options.author; return a.innerHTML = c })
                ...
                var a, b; a = this; (b = a.$element.find("." + a.classes.title)[0]) && a.audio.addEventListener("durationchange", function () {
                    var c; a.playListName ? (c = a.$doc.find('[data-rd-audio-playlist="' + a.playListName +
                        '"]:not(.' + a.classes.playlist + ') li[data-index="' + a.index + '"]'), c = c[0].getAttribute("data-rd-audio-title")) : c = a.options.title; return b.innerHTML = c
                })
            }; d.prototype.updateCurrentTime = function (a) { var b, c; c = ("0" + Math.floor(this.audio.currentTime)).slice(-2); b = ("0" + Math.floor(c / 60 % 60)).slice(-2); a.innerHTML = b + ":" + c }; d.prototype.attachVolumeButtonListener = function () { var a; a = this; a.$element.find("." + a.classes.volume).on("click", function (b) { b.preventDefault(); a.audio.muted = !a.isMuted() }) }; d.prototype.attachNextTrackButtonListener =
            function () { var a; a = this; a.$element.find("." + a.classes.nextButton).on("click", function (b) { b.preventDefault(); b = a.$doc.find('[data-rd-audio-playlist="' + a.playListName + '"] li[data-index="' + (parseInt(a.index) + 1) + '"]').length ? [a.playListName, parseInt(a.index) + 1] : [a.playListName, 0]; a.$doc.trigger("playlistClick", b) }) }; d.prototype.attachPrevTrackButtonListener = function () {
                var a; a = this; a.$element.find("." + a.classes.prevButton).on("click", function (b) {
                    b.preventDefault(); 0 <= parseInt(a.index) - 1 ? b = [a.playListName,
                  parseInt(a.index) - 1] : (b = a.$doc.find('[data-rd-audio-playlist="' + a.playListName + '"]'), b = [a.playListName, b.eq(b.length - 1).find("li").last().attr("data-index")]); a.$doc.trigger("playlistClick", b)
                })
            }; d.prototype.removeStateClass = function (a) { var b, c, e, d; c = a.element.className.split(/\s+/); e = 0; for (d = c.length; e < d; e++) b = c[e], -1 !== b.indexOf("state-") && a.element.classList.remove(b) }; d.prototype.createProgressBar = function () {
                var a, b, c, e; c = this; c.$element.find("." + c.classes.progressBar).length && (c.currentProgress =
            ...
            d.prototype.attachProgressBarSlider = function () { var a; a = this; a.$element.find("." + a.classes.progressBarSlider).length && (a.progressSlider = a.$element.find("." + a.classes.progressBarSlider)[0]); a.audio.addEventListener("seeked", function () { return a.progressSlider.style.left = a.audio.currentTime / a.getDuration() * 100 + "%" }) }; d.prototype.createVolumeBar = function () {
                var a, b, c, e; c = this; c.$element.find("." + c.classes.volumeBar).length && (c.currentVolume = e = k.createElement("div"), e.classList.add("current"), e.style.width =
                    100 * c.audio.volume + "%", c.attachVolumeBarSlider(), a = c.$element.find("." + c.classes.volumeBar)[0], c.getOption("volumeBarType") && a.classList.add("rd-audio-volume-bar-" + c.getOption("volumeBarType")), b = !1, f(a).on("mousedown.rd touchstart.rd", function (e) {
                        if (1 === e.which || g) b = !0, c.audio.volume = c.getClickBarPosition(e, a, c.getOption("volumeBarType")), c.isMuted() && (c.audio.muted = !1), c.$doc.on("mouseup.rd touchend.rd touchcancel.rd", function (a) { if (b) return b = !1 }), c.$doc.on("mousemove.rd touchmove.rd", function (e) {
                            b &&
                ...
                var a; a = this; a.$element.find("." + a.classes.volumeBarSlider).length && (a.volumeBarSlider = a.$element.find("." + a.classes.volumeBarSlider)[0]); a.audio.addEventListener("volumechange", function () {
                    if ("horizontal" === a.getOption("volumeBarType")) return a.isMuted() ? a.volumeBarSlider.style.left = "0" : a.volumeBarSlider.style.left =
                        100 * a.audio.volume + "%"; if ("vertical" === a.getOption("volumeBarType")) return a.isMuted() ? a.volumeBarSlider.style.bottom = "0" : a.volumeBarSlider.style.bottom = 100 * a.audio.volume + "%"
                })
            }; d.prototype.playlistPlayPause = function (a, b) { null != b && b ? (this.audio.play(), a.addClass("playing")) : !1 === b ? (this.audio.pause(), a.addClass("paused")) : this.isPlaying() ? (this.audio.pause(), a.addClass("paused")) : (this.audio.play(), a.addClass("playing")) }; d.prototype.initPlaylistClickListener = function () {
                var a; a = this; a.$element.find("." +
                a.classes.playlist).length && (a.playlist = a.$element.find("." + a.classes.playlist)[0]); null == a.index && (a.index = -1); a.$doc.on("playlistClick", function (b, c, e, d) {
                    a.clearPlayListClasses(); b = a.$doc.find('[data-rd-audio-playlist="' + c + '"] li[data-index="' + e + '"]'); b.length && (null != a.playListName && a.playListName === c ? null != a.index && a.index === e ? a.playlistPlayPause(b) : (a.loadTrack(b[0].getAttribute("data-rd-audio-src")), a.playlistPlayPause(b, !0), a.index = e) : (a.playListName = c, a.index = e, a.loadTrack(b[0].getAttribute("data-rd-audio-src")),
                ...
                var a, b, c, e, d; a = this; d = a.$doc.find("[data-rd-audio-playlist]"); a.setPlaylistIndexes(d); b = 0; for (c = d.length; b < c; b++) e = d[b], f(e).find(e.getAttribute("data-rd-audio-play-on")).on("click", function (a) {
                    var b; b = f(this); "A" === this.tagName && a.preventDefault(); a = b.parents("[data-index]").length ? b.parents("[data-index]").attr("data-index") : this.getAttribute("data-index");
                    b = [b.parents("[data-rd-audio-playlist]").attr("data-rd-audio-playlist"), parseInt(a)]; return f(k).trigger("playlistClick", b)
                }); null != a.playlist && a.$doc.delegate("." + a.classes.playlist + " li", "click", function () { var b; b = parseInt(this.getAttribute("data-index")); return a.$doc.trigger("playlistClick", [a.playListName, b]) }); a.options.playListName && (a.index = 0, b = [a.options.playListName, 0, a.getOption("autoplay")], a.$doc.trigger("playlistClick", b))
            }; d.prototype.loadTrack = function (a) { this.audio.src = a; this.audio.load() };
            d.prototype.clearPlayListClasses = function () { this.$doc.find("[data-rd-audio-playlist] .paused").removeClass("paused"); this.$doc.find("[data-rd-audio-playlist] .playing").removeClass("playing") }; d.prototype.setPlaylistIndexes = function (a) {
                var b, c, e, d, h, g; h = []; b = []; c = 0; for (d = a.length; c < d; c++) g = a[c], -1 === h.indexOf(g.getAttribute("data-rd-audio-playlist")) ? (e = h.length, h.push(g.getAttribute("data-rd-audio-playlist")), b.push(0)) : e = h.indexOf(g.getAttribute("data-rd-audio-playlist")), f(g).find("li").each(function () {
                    this.setAttribute("data-index",
                        b[e]); return b[e] += 1
                })
            }; d.prototype.addToPlaylist = function (a, b, c, e) {
                var d; a = this; null != a.playlist && (a.audio.pause(), d = "", a.$doc.find('[data-rd-audio-playlist="' + b + '"]').each(function () {
                    return f(this).find("li").each(function () {
                        var a; a = ""; parseInt(this.getAttribute("data-index")) === c && (a = null == e || e ? "playing" : "paused"); d += '<li class="' + a + '" data-rd-audio-src="' + this.getAttribute("data-rd-audio-src") + '" data-index="' + this.getAttribute("data-index") + '">'; d += '<span class="song-author">' + this.getAttribute("data-rd-audio-author") +
                        "</span> - "; d += '<span class="song-title">' + this.getAttribute("data-rd-audio-title") + "</span>"; return d += "</li>"
                    })
                }), a.playlist.setAttribute("data-rd-audio-playlist", b), a.playlist.innerHTML = d)
            }; d.prototype.attachPlayerEvents = function () {
                var a, b, c; b = this; a = b.audio; c = b.$element.find("." + b.classes.currentTime); a.addEventListener("canplay", function () {
                    b.element.classList.remove("state-loading"); c.length && b.updateCurrentTime(c[0]); if (null != b.volumeBarSlider) {
                        if ("horizontal" === b.getOption("volumeBarType")) return b.volumeBarSlider.style.left =
                        100 * b.audio.volume + "%"; if ("vertical" === b.getOption("volumeBarType")) return b.volumeBarSlider.style.bottom = 100 * b.audio.volume + "%"
                    }
                }); a.addEventListener("canplaythrough", function () { return b.element.classList.remove("state-loading") }); a.addEventListener("play", function () { b.removeStateClass(b); return b.element.classList.add("state-playing") }); a.addEventListener("playing", function () { b.removeStateClass(b); return b.element.classList.add("state-playing") }); a.addEventListener("pause", function () {
                    b.removeStateClass(b);
                    return b.element.classList.add("state-pause")
                }); a.addEventListener("ended", function () { var a; if (b.options.loop) return b.audio.currentTime = 0, b.audio.play(); if (null != b.playlist) return a = b.$doc.find('[data-rd-audio-playlist="' + b.playListName + '"] li[data-index="' + (parseInt(b.index) + 1) + '"]').length ? [b.playListName, parseInt(b.index) + 1] : [b.playListName, 0], b.$doc.trigger("playlistClick", a) }); a.addEventListener("volumechange", function () {
                    if (b.isMuted() || 0 === b.audio.volume) {
                        b.element.classList.add("muted"); if ("horizontal" ===
                          b.getOption("volumeBarType")) return b.currentVolume.style.width = 0; if ("vertical" === b.getOption("volumeBarType")) return b.currentVolume.style.height = 0
                    } else { b.element.classList.remove("muted"); if ("horizontal" === b.getOption("volumeBarType")) return b.currentVolume.style.width = 100 * b.audio.volume + "%"; if ("vertical" === b.getOption("volumeBarType")) return b.currentVolume.style.height = 100 * b.audio.volume + "%" }
                }); a.addEventListener("timeupdate", function () {
                    var d; null != b.currentProgress && (d = a.currentTime / b.getDuration() *
                    100 + "%", b.currentProgress.style.width = d); null != b.progressSlider && (b.progressSlider.style.left = d); if (c.length) return b.updateCurrentTime(c[0])
                }); a.addEventListener("loadstart", function () { b.removeStateClass(b); return b.element.classList.add("state-loading") }); a.addEventListener("waiting", function () { b.removeStateClass(b); return b.element.classList.add("state-loading") })
            }; d.prototype.getClickBarPosition = function (a, b, c) {
                a.preventDefault(); if ("horizontal" === c) return c = b.getBoundingClientRect().left, b = b.clientWidth,
            a.originalEvent && (a = a.originalEvent), a = g ? a.targetTouches[0].pageX : a.pageX, Math.min(1, Math.max(0, (a - c) / b)); if ("vertical" === c) return c = b.getBoundingClientRect().bottom, b = b.clientHeight, a.originalEvent && (a = a.originalEvent), a = g ? a.targetTouches[0].pageY : a.pageY, Math.min(1, Math.max(0, (c - a) / b))
            }; d.prototype.isPlaying = function () { return this.audio && !this.audio.paused }; d.prototype.isPaused = function () { return this.audio && this.audio.paused }; d.prototype.isMuted = function () { return this.audio.muted }; d.prototype.isLoading =
                function () { return !this.state && this.isEmpty() ? !1 : this.audio.networkState === this.audio.NETWORK_LOADING && this.audio.readyState < this.audio.HAVE_FUTURE_DATA }; d.prototype.isErrored = function () { return this.audio.error || this.audio.networkState === this.audio.NETWORK_NO_SOURCE }; d.prototype.isEmpty = function () { return this.audio.readyState === this.audio.HAVE_NOTHING }; d.prototype.getDuration = function () { return this.audio.duration }; d.prototype.createDataApi = function () {
                    ...
                    this.$element.attr("data-rd-audio-autoplay") && (this.options.autoplay = "true" === this.$element.attr("data-rd-audio-autoplay")); this.$element.attr("data-rd-audio-loop") && (this.options.loop = "true" === this.$element.attr("data-rd-audio-loop"))
                }; d.prototype.getOption = function (a) { var b, c; for (b in this.options.responsive) b <= l.innerWidth && (c = b); return null != this.options.responsive && null != this.options.responsive[c][a] ? this.options.responsive[c][a] : this.options[a] }; return d
        }(); f.fn.extend({
            RDAudio: function (d) {
                return this.each(function () {
                    var a;
                    a = f(this); if (!a.data("RDAudio")) return a.data("RDAudio", new m(this, d))
                })
            }
        }); return l.RDAudio = m
    })(window.jQuery, document, window); "undefined" !== typeof module && null !== module ? module.exports = window.RDAudio : "function" === typeof define && define.amd && define(["jquery"], function () { return window.RDAudio })
}).call(this);
/**
 * @module       Slick
 * @author       Ken Wheeler
