iapiConf = {"casinoname":"greatfortune88","loginServer":"login.greatfortune88.com","clientSkin":"greatfortune88","clientType":"casino","clientPlatform":"flash","clientVersion":null,"systemId":"423","serviceType":"GamePlay","loginDomainRetryCount":"2","loginDomainRequestTimeout":"30","loginDomainRetryInterval":"1","fingerprintEnabled":"0","onlypostrequestsforlogout":null,"useIframeForGetLoggedInPlayer":"0","syncDone":"0","syncHops":5};
...
function iapiLoginIdTokenCodeAndPin(tokenCode, pin, language)
{
    iapiLoginModeDownload = false;
    iapiLoginModeFlash = false;
    iapiAuthenticationType = iapiLoginTypes.TOKEN_CODE;
    iapiBaseLogin(tokenCode, pin, 1, language);
    return iapiERR_OK;
};

function iapiLoginPrintedIdTokenCodeAndPin(printedTokenCode, pin, language)
{
    iapiLoginModeDownload = false;
    iapiLoginModeFlash = false;
    iapiAuthenticationType = iapiLoginTypes.PRINTED_TOKEN_CODE;
    iapiBaseLogin(printedTokenCode, pin, 1, language);
    return iapiERR_OK;
};

function iapiLoginUsernameAndPin(user, pin, language)
{
    iapiLoginModeDownload = false;
    iapiLoginModeFlash = false;
    iapiAuthenticationType = iapiLoginTypes.USERNAME_AND_PIN;
    iapiBaseLogin(user, pin, 1, language);
    return iapiERR_OK;
};
